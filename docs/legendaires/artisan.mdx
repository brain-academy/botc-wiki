...
-   Si vous avez créé une liste de rôles en utilisant l'option Teensyville dans l'outil de script, vous voudrez peut-être utiliser l'Artisan. Les parties se déroulant à Teensyville ne comptent que six Villageois, deux Marginaux, deux Sbires et un Démon sur la liste, et elles sont spécifiquement conçues pour cinq ou six joueurs. 
...
Si vous avez créé une liste de rôles en utilisant l'option Teensyville dans l'outil de script, vous voudrez peut-être utiliser l'Artisan. Les parties se déroulant à Teensyville ne comptent que six Villageois, deux Marginaux, deux Sbires et deux Démon sur la liste, et elles sont spécifiquement conçues pour cinq ou six joueurs. 
