...
> Un <Role BOUC_EMISSAIRE /> Maléfique est assis entre l’<Role IMP /> et un Sbire et deux autres sbires sont assis l’un à côté de l’autre. Le <Role CUISTOT /> obtient ‘3’ (soit 3 paires : 2 paires pour les 3 personnes à côté : <Role IMP />/<Role BOUC_EMISSAIRE /> + <Role BOUC_EMISSAIRE /> / <Role IMP /> puis la 3eme paire pour les deux autres Sbires qui sont côte à côte).
...
- Annoncer qu’il y a soit “0” ou “1” paire de joueurs Maléfiques assis l’un à côté de l’autre est assez commun. Des annonces plus élevées (2-3 ou +) étant statistiquement plus rares, vous pourriez vite devenir suspect. Faites aussi attention à ce que le nombre de paires annoncées soit cohérent avec le nombre de joueurs Maléfiques dans la partie. En général, même si le <Role RECLUS /> s'enregistre comme maléfique pour le Cuistot, il ne peut jamais y avoir plus de paires que de joueurs maléfiques. Dans Trouble Breing, la seule faon de dépasser 4 est d'avoir des voyageurs maléfiques.
