...
> Le Noble apprend Doc Feyn et Pras. Doc est la <Role FEMME_DE_CHAMBRE />, Feyn est le <Role BARBIER />. Pras est le <Role RECLUSE /> qui est considéré comme maléfique pour le Noble.

> La troisième nuit, la <Role GUENAUDE /> transforme Florine en Noble. Florine apprend qu’une personne parmi Gil, Jonathan et Mathis est maléfique. Toutefois, Jonathan est l’<Role ESPIONNE /> maléfique considéré comme gentil pour le Noble et Mathis est le <Role PO /> qui est aussi maléfique.
...
- <Role RECLUSE /> / <Role ESPIONNE /> : Peut être vu comme gentil ou maléfique par le Noble. 
