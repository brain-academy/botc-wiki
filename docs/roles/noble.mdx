...
> La troisième nuit, la <Role VIEILLE_CHOUETTE /> transforme Florine en <Role NOBLE />. Florine apprend qu’une personne parmi Gil, Jonathan et Julien est maléfique. Toutefois, Jonathan est l’<Role ESPION /> maléfique considéré comme gentil pour le <Role NOBLE /> et Julien est le <Role PO /> qui est aussi maléfique.
