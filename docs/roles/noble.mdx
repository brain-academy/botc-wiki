...
> Le Noble apprend Doc Feyn et Pras. Doc est la <Role FEMME_DE_CHAMBRE />, Feyn est le <Role BARBIER />. Pras est la <Role RECLUSE /> qui est considérée comme maléfique pour le Noble.

> La troisième nuit, la <Role GUENAUDE /> transforme Florine en Noble. Florine apprend qu’une personne parmi Gil, Jonathan et Mathis est maléfique. Toutefois, Jonathan est l’<Role ESPIONNE /> maléfique considérée comme gentille pour le Noble et Mathis est le <Role PO /> qui est aussi maléfique.
...
- <Role RECLUSE /> / <Role ESPIONNE /> : Peut être vue comme gentille ou maléfique par le Noble. 
