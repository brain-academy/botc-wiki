...
> La troisième nuit, la <Role VIEILLE_CHOUETTE /> transforme Florine en Noble. Florine apprend qu’une personne parmi Gil, Jonathan et Mathis est maléfique. Toutefois, Jonathan est l’<Role ESPION /> maléfique considéré comme gentil pour le Noble et Mathis est le <Role PO /> qui est aussi maléfique.
