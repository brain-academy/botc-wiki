...
> Le <Role NOBLE /> apprend Doc Feyn et Pras. Doc est la <Role FEMME_DE_CHAMBRE />, Feyn est le <Role BARBIER />. Pras est le <Role RECLUS /> qui est considéré comme maléfique pour le <Role NOBLE />.
