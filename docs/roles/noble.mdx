...
> La troisième nuit, la <Role VIEILLE_CHOUETTE /> transforme Florine en Noble. Florine apprend qu’une personne parmi Gil, Jonathan et Mathis est maléfique. Toutefois, Jonathan est l’<Role ESPIONNE /> maléfique considéré comme gentil pour le Noble et Mathis est le <Role PO /> qui est aussi maléfique.
...
- <Role RECLUS /> / <Role ESPIONNE /> : Peut être vu comme gentil ou maléfique par le Noble. 
