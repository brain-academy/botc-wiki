...
> Le <Role FERMIERE /> est choisi par la Harpie. Comme il n'a pas d'informations pouvant impliquer qu'un joueur est maléfique, il fait un effort pour trouver des informations qui pourraient innocenter les autres joueurs en vie laissant sa cible comme plus probablement Démon et donc maléfique.
