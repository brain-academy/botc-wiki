...
> Le <Role ZOMBUUL /> est exécuté, meurt une première fois et apparaît mort. La capacité du Conspirateur ne s’active pas, car le <Role ZOMBUUL /> n’est pas vraiment mort. Quand le <Role ZOMBUUL /> est exécuté une seconde fois, il meurt pour de vrai, la capacité du Conspirateur s’active et la partie continue pour une journée de plus.
