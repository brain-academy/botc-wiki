...
- Un conspirateur mort est un conspirateur inoffensif. Comme tout joueur, le conspirateur ne peut plus utiliser sa capacité une fois mort. Exécutez autant de joueurs que possible, dans l’espoir de tuer le conspirateur avant le Démon. Comme l’<Role AVOCAT_DU_DIABLE />, le conspirateur n’est utile que s’il reste en vie. Ne ratez pas une occasion d’exécution. Faites de votre mieux pour trouver les Sbires et priez votre bonne étoile.
