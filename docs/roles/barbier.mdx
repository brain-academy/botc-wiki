...
> Le Barbier meurt. Le <Role VIGORMORTIS /> s’échange lui-même avec une <Role DULCINEE /> morte. L’ancien <Role VIGORMORTIS /> est maintenant une <Role DULCINEE /> Maléfique. Comme la <Role GUENAUDE /> a créé un Démon Gentil la nuit précédente, la partie continue.
...
- Combinaison intéressante ! Si vous mourrez dans une partie avec deux autres maléfiques, faites en sorte qu'ils prétendent que leurs rôles ont étés échangés. Cela vous rend digne de confiance en tant que Barbier et vos comparses aussi. Par exemple, si vous êtes la <Role SORCIERE /> qui prétend être le Barbier et meurt. Le jour suivant, le <Role VIGORMORTIS /> et la <Role GUENAUDE /> qui prétendaient être le <Role REVEUR /> et le <Role SAGE /> disent au village que leurs rôles a changé et qu'ils sont maintenant <Role REVEUR /> et <Role SAGE />. Jeu set et match. 
