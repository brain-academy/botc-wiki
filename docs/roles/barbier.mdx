...
> Le Barbier meurt. Le Démon réfléchit à échanger l’<Role HORLOGER /> et le <Role JONGLEUR /> mais décide finalement de ne rien faire.

> Le Barbier meurt. Le Démon échange les rôles d’un <Role ORACLE /> vivant avec un Barbier mort. Il y a maintenant un Barbier en vie et un <Role ORACLE /> mort.

> Le Barbier meurt. Le <Role VORTOX /> s’échange lui-même avec une <Role SORCIERE />.

> Le Barbier meurt. Le <Role VIGORMORTIS /> s’échange lui-même avec une <Role DULCINEE /> morte. L’ancien <Role VIGORMORTIS /> est maintenant une <Role DULCINEE /> Maléfique. Comme la <Role VIEILLE_CHOUETTE /> a créé un Démon Gentil la nuit précédente, la partie continue.
...
Si le Barbier meurt, marquez-le avec le jeton de rappel "Rase gratis cette nuit".

Durant la nuit, réveillez le Démon. Montrez-lui le jeton d’information « ce rôle t’a choisi » puis le jeton de rôle du Barbier. Le Démon peut alors faire non de la tête ou désigner deux joueurs. Rendormez le Démon. Retirez le jeton de rappel "Rase gratis cette nuit".
...
_Si un joueur gentil devient Sbire ou Démon ou qu’un joueur maléfique devient un Villageois ou un Marginal, vous pourriez leur rappeler que leur alignement n’a pas changé._
