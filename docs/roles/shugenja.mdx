...
> La <Role MARIONETTE /> est à 1 place du shugenja dans le sens horaire. La <Role VEUVE_NOIRE /> est à 1 place du shugenja dans le sens antihoraire. Le shugenja se réveille et le conteur choisit de dire au shugenja que le joueur maléfique le plus proche est dans le sens horaire.
