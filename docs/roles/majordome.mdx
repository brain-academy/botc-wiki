...
-	Chaque nuit, le Majordome choisit un joueur pour qu’il devienne son maître. Cela peut être le même joueur que la nuit dernière ou un joueur différent.
...
-	Si le maître a sa main baissée, signalant ainsi qu’il ne vote pas ou si le maître baisse la main avant que son vote ne soit compté, le Majordome doit également baisser sa main.
...
-	Les joueurs morts ne peuvent lever la main pour voter que s’il leur reste leur dernier vote. Si le Majordome choisit un mort comme maître, cela s’applique toujours.
...
- Bien que vous puissiez voter OUI uniquement lorsque votre maître a levé la main, vous n’êtes pas obligé de le faire. Tâchez de voter pour les joueurs que vous pensez vraiment Maléfiques.
...
Si le Majordome vote illégalement par accident, comptez tout de même le vote du Majordome. Si vous ne le faites pas, le total sera inférieur à ce qu’il devrait être et tout le monde saura qui est le Majordome ce qui est injuste pour les Maléfiques. Les erreurs arrivent, poursuivez simplement la partie et discutez en privé avec le Majordome plus tard.