...
> La <Role VOYANTE /> est sur le point d’être exécuté mais le Conteur choisit d’exécuter le gentil Bouc émissaire à la place. La <Role VOYANTE /> reste en vie et le Bouc émissaire meurt. Cette nuit, le <Role CROQUE_MORT /> apprend que le Bouc émissaire a été exécuté aujourd’hui.
