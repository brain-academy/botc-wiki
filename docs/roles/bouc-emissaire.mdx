...
> La <Role VOYANTE /> est sur le point d’être exécutée, mais le Conteur choisit d’exécuter le Gentil Bouc émissaire à la place. La <Role VOYANTE /> reste en vie et le Bouc émissaire meurt. Cette nuit, le <Role FOSSOYEUR /> apprend que le Bouc émissaire a été exécuté aujourd’hui.
...
> L’<Role ESPIONNE /> est sur le point d’être exécutée. Le Gentil Bouc émissaire est exécuté à sa place
...
- Après avoir discuté avec un joueur dont la vie vient d’être sauvée, faites tout ce qui est en votre pouvoir pour convaincre le reste du Village qu’il est Gentil. Vous avez des faits de notoriété publique pour vous aider à y arriver :
  ...
  -	Vous et le joueur sauvé avez le même alignement. S’il y a un <Role CUISTOT /> ou un <Role EMPATHE /> en jeu, leurs informations devraient converger vers le fait que vous soyez bien du même alignement. Si un <Role ENQUETEUR /> ou une <Role VOYANTE /> est jeu, leurs informations pourraient diverger du fait que vous soyez tous les deux Maléfiques. Il est rare qu’une information comme « deux joueurs sont du même alignement » soit su publiquement, alors utilisez-le pleinement.
