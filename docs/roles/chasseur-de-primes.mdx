...
- <Role FERMIERE /> : Même si le fermier est maléfique, un joueur gentil vivant devient le fermier.
...
- <Role SOULARD /> / <Role MARIONNETTE /> : Si le Chasseur de primes doit être le Soûlard ou la Marionnette, ça doit être décidé avant qu’un Villageois soit réveillé pour l’informer de son alignement maléfique (en conséquence de la capacité du Chasseur de primes). Le Soûlard et la Marionnette ne sont pas des cibles valides de Villageois à passer maléfique par la capacité du Chasseur de primes.

- <Role ESPIONNE /> : “Techniquement” peut être considéré comme Villageois à faire passer maléfique par la capacité du Chasseur de primes…. Faites pas l’idiot.
...
- <Role KAZALI /> : Jinx - “Si le Kazali transforme le Chasseur de primes en Sbir, un Villageois maléfique n'est pas créé."
