...
> La première nuit, le <Role CHASSEUR_DE_PRIMES /> apprend que Yann est maléfique. Yann est le <Role ROI /> qui est passé maléfique à cause du <Role CHASSEUR_DE_PRIMES />. Le jour suivant, le <Role ROI /> meurt. La nuit suivante, le <Role CHASSEUR_DE_PRIMES /> apprend que Pras est maléfique. Pras est le <Role GOBELIN />. 

> La première nuit, le <Role CHASSEUR_DE_PRIMES /> apprend qu’Alex est maléfique. Trois jours plus tard, Alex meurt. Cette nuit, le <Role CHASSEUR_DE_PRIMES /> apprend qu’Aurélie est maléfique. Aurélie est un sbire. Trois nuits plus tard, le démon tue Aurélie et le <Role CHASSEUR_DE_PRIMES /> apprend que Kaïna est maléfique. Kaïna est le démon. L’herboriste qui a été rendu maléfique à cause du <Role CHASSEUR_DE_PRIMES /> est toujours vivant.
...
- <Role KAZALI /> : Jinx - “Un villageois maléfique n’est créé que si le <Role CHASSEUR_DE_PRIMES /> est toujours en jeu après que le <Role KAZALI /> ait agit.” 
