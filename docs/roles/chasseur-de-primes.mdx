...
> Pras est le Chasseur de primes, Yann est la <Role HARPIE /> et Aurélie est l'<Role HERBORISTE />. Durant la préparation de la partie, le Conteur décide qu'Aurélie sera maléfique. La première nuit, Pras apprend Benji. Le troisième jour, Benji est exécuté. Cette nuit là, Pras apprend Aurélie.
...
> Alex est le <Role SOULARD /> qui pense être le Chasseur de primes. Aucun Villageois n'est passé maléfique à la préparation de la partie car le Chasseur de primes n'est pas en jeu. La première nuit, Alex apprend  Mohammed qui est l'<Role EMPATHIQUE /> gentil. Quand Mohammed meurt, Alex apprend Léonard qui est le gentil <Role FLEURISTE />.
...
Durant la première nuit, réveillez le Chasseur de primes. Désignez le joueur marqué « Traqué ». Rendormez le Chasseur de primes.

A chaque fois que le joueur marqué « Traqué » meurt, marquez un nouveau joueur avec le rappel « Traqué ». Cette nuit, réveillez le Chasseur de primes et désignez sa nouvelle cible puis rendormez le Chasseur de primes
...
- <Role KAZALI /> : Jinx - “Un Villageois maléfique n'est créé que si le Chasseur de primes est encore en jeu après l'action du Kazali.” 
