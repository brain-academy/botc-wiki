...
-   Le Chasseur de primes commence en apprenant un joueur maléfique. Quand ce joueur meurt, il apprend un autre joueur maléfique.

-   Le Chasseur de primes apprend seulement que ce joueur est maléfique. Il n'apprend pas son rôle.

-   Si le Chasseur de primes est ivre ou empoisonné quand il doit apprendre une nouvelle cibre, le Conteur peut lui désigner un joueur gentil. Quand le dernier joueur désigné meurt, le Chasseur de primes apprend une nouvelle cible cette nuit.

-   Le Chasseur de primes ne peut pas apprendre deux fois le même joueur maléfique.

-   Si le Chasseur de primes est jeu lors de la préparation de la partie, un Villageois est maléfique. Le Chasseur de primes pourrait apprendre le Villageois maléfique.

### Exemples

> Pras est le Chasseur de primes, Yann est la <Role HARPIE /> et Aurélie est l'<Role TISANIERE />. Durant la préparation de la partie, le Conteur décide qu'Aurélie sera maléfique. La première nuit, Pras apprend Benji. Le troisième jour, Benji est exécuté. Cette nuit là, Pras apprend Aurélie.

> La première nuit, le Chasseur de primes apprend Julian qui est le <Role BARON /> maléfique. Quand Julian meurt, l'<Role EMPOISONNEUR /> cible le Chasseur de primes. Cette nuit, le Chasseur de primes apprend Laurianne qui est le <Role MAGICIEN /> gentil.

> Alex est l'<Role IVROGNE /> qui pense être le Chasseur de primes. Aucun Villageois n'est passé maléfique à la préparation de la partie car le Chasseur de primes n'est pas en jeu. La première nuit, Alex apprend  Mohammed qui est l'<Role EMPATHE /> gentil. Quand Mohammed meurt, Alex apprend Léonard qui est le gentil <Role FLEURISTE />.
...
- Vous dévoilez comme Chasseur de primes jeter beaucoup de doute sur d’autres joueurs. Vous pouvez faire tuer des joueurs clés et saper la confiance entre les joueurs. Chercher des rôles qui détectent l’alignement comme l’<Role EMPATHE /> ou le <Role CHEF_DE_SECTE /> car ils peuvent découvrir que vous mentez.
...
- <Role COURTISAN /> : Même s’il choisit le Chasseur de primes la première nuit, cela n’empêche pas un Villageois de passer maléfique car c’est une capacité qui s’applique à la préparation de la partie.

- <Role PLANTEUR_DE_PAVOT /> : Le Villageois maléfique n’est pas Sbire ou Démon donc il ne connaît pas les maléfique quand le Planteur de pavot meurt.

- <Role PHILOSOPHE /> : Si le Philosophe prend la capacité du Chasseur de primes, un Villageois pourrait passer maléfique.

- <Role FERMIERE /> : Même si la fermière est maléfique, un joueur gentil vivant devient la fermière.

- <Role FOU_DU_ROI /> : Si le Fou du roi est le joueur que connaît le Chasseur de primes, le Chasseur n’aura pas de nouvelles cibles avant que le Fou du roi ne meurt pour de bon (= la deuxième fois qu’il meurt)
...
- <Role IMMACULEE /> : Un Villageois maléfique peut déclencher la capacité de l'Immaculée.
...
- <Role DAMOISELLE /> : Si un Villageois maléfique devine la Damoiselle, rien ne se passe car il n’est pas Sbire. La tentative n’est pas utilisée.

- <Role RECLUSE /> : Le Chasseur de primes peut apprendre la Recluse comme joueuse maléfique.

- <Role IVROGNE /> / <Role MARIONNETTE /> : Si le Chasseur de primes doit être l'Ivrogne ou la Marionnette, ça doit être décidé avant qu’un Villageois soit réveillé pour l’informer de son alignement maléfique (en conséquence de la capacité du Chasseur de primes). L'Ivrogne et la Marionnette ne sont pas des cibles valides de Villageois à passer maléfique par la capacité du Chasseur de primes.

- <Role ESPIONNE /> : “Techniquement” peut être considéré comme Villageoise à faire passer maléfique par la capacité du Chasseur de primes…. Faites pas l’idiot.
...
- <Role KAZALI /> : Jinx - “Si le Kazali transforme le Chasseur de primes en Sbire, un Villageois maléfique n'est pas créé."
...
- <Role TIMONSTRE /> : Le Villageois maléfique n’est pas un Sbire et donc ne se réveille pas pour choisir un babysitter.

- <Role SSANGSUE /> : Si la Ssangsue choisis le Chasseur de primes ou le Villageois maléfique comme hôte, cela n’empêche pas un Villageois d’être maléfique à cause de la capacité du Chasseur de primes car c’est une capacité d’installation [entre crochets].
