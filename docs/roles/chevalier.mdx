...
-   Le Chevalier peut apprendre des Villageois, des Marginaux ou même des Sbires mais n'apprend le type de rôle des joueurs.

### Exemples

> Jérôme est le <Role FOSSOYEUR />, Yann est le <Role IMP /> et Aurélie est la <Role VOYANTE />. Le Chevalier apprend Jérôme et Aurélie.

> Adrien est le <Role VORTOX /> et Florine est l'<Role ALCHIMISTE />. Le Chevalier apprend Adrien et Florine. Le Chevalier doit apprendre Adrien car l'information du Chevalier doit être fausse à cause de la capacité du <Role VORTOX /> et donc doit inclure le Démon.
...
Durant la préparation de la partie, marquez deux joueurs qui ne sont pas Démons par le jeton de rappel " Appris " du Chevalier. Durant la première nuit, réveillez le Chevalier. Désignez lui les deux joueurs marqués " Appris ".
...
- <Role RECLUSE /> : La Recluse pourrait ou ne pourrait pas être montrée au Chevalier. Le Conteur choisis comment considérer la Recluse.
