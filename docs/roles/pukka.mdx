...
> La <Role GITANE /> est exécutée et meurt et choisit la <Role COURTISAN />. Cette nuit, le Pukka choisit la <Role GITANE />. La <Role COURTISAN /> ne meurt pas car la <Role GITANE /> est empoisonnée.
