...
Notez que l’Alchimiste a sa capacité à l’installation de la partie. C’est là que vous déciderez de la capacité de l’Alchimiste donc les capacités [entre crochets] des Sbires sont à appliquer. Par exemple ; un Alchimiste baron ou parrain modifiera le compte d’Etranger, etc…
