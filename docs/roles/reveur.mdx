...
> Aujourd’hui, le <Role JUMEAU_MALEFIQUE /> et l’<Role ARTISTE /> prétendent être l’<Role ARTISTE />. Cette nuit, le Rêveur choisit le joueur qui est le <Role JUMEAU_MALEFIQUE />. Si le Conteur veut aider le village, il pourrait montrer <Role JUMEAU_MALEFIQUE /> ou <Role DULCINEE />. Mais le Conteur décide d’aider les maléfiques et montre <Role JUMEAU_MALEFIQUE /> et <Role ARTISTE /> au Rêveur.
