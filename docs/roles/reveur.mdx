...
Chaque nuit, choisissez un joueur (en dehors de vous-même et d'un Voyageur) : Vous apprenez un rôle gentil et un rôle du camp opposé. L'un d'entre eux est correct.
...
-	Le jeton du rôle faux est choisi en fonction du type du jeton de rôle du joueur choisi. Si le rêveur choisit un joueur qui est villageois ou étranger, le je ton du faux rôle sera celui d’un sbire ou d’un Sbire ou d’un démon. S’il choisit un sbire ou un démon, le jeton du faux rôle sera celui d’un villageois ou d’un étranger.
