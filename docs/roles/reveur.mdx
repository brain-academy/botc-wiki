...
-	Chaque nuit, le Rêveur choisit un joueur et apprend deux rôles. Un que le joueur est et un que le joueur n’est pas.

-	Le jeton du rôle faux est choisi en fonction du type du jeton de rôle du joueur choisi. Si le Rêveur choisit un joueur qui est Villageois ou Marginal, le jeton du faux rôle sera celui d’un Sbire ou d’un Démon. S’il choisit un Sbire ou un Démon, le jeton du faux rôle sera celui d’un Villageois ou d’un Marginal.

-	Le Rêveur ne peut pas se choisir lui-même ni un Voyageur. 

### Exemples  

> Le Rêveur choisit un joueur qui est la <Role BETE_DE_FOIRE />. Le Rêveur apprend que ce joueur est soit la <Role BETE_DE_FOIRE /> soit le <Role MANIPULATEUR />.

> Le Rêveur choisit un joueur qui était le <Role PHILOSOPHE /> mais qui a pris la capacité du <Role FLEURISTE /> plutôt dans la nuit. Le Rêveur apprend que ce joueur est soit le <Role PHILOSOPHE />, soit le <Role VIGORMORTIS />.

> Aujourd’hui, le <Role JUMELLE_MALEFIQUE /> et l’<Role ARTISTE /> prétendent être l’<Role ARTISTE />. Cette nuit, le Rêveur choisit le joueur qui est le <Role JUMELLE_MALEFIQUE />. Si le Conteur veut aider le village, il pourrait montrer <Role JUMELLE_MALEFIQUE /> ou <Role DULCINEE />. Mais le Conteur décide d’aider les maléfiques et montre <Role JUMELLE_MALEFIQUE /> et <Role ARTISTE /> au Rêveur.

> Le Rêveur choisit le joueur qui est le <Role VORTOX />. L’information du Rêveur doit être fausse à cause du <Role VORTOX /> alors le Rêveur apprend que ce joueur est soit l’ <Role ORACLE />, soit le <Role NO_DASHII />.
...
- Si vous avez un <Role JUMELLE_MALEFIQUE />, ne perdez de temps à le vérifier. Vous recevrez le rôle du gentil jumeau et le <Role JUMELLE_MALEFIQUE /> pour les deux joueurs, ce qui n’est… pas très utile. Vous pouvez néanmoins vérifier le <Role VORTOX /> de cette façon puisque l’information doit être fausse. 

### Bluffer le Reveur

- Le premier jour est le plus dur. Si vous vous dévoilez tôt dans le premier jour vous le ferez avant que d'autres joueurs se dévoilent. Il est plus facile de prétendre avoir choisi un camarade maléfique et espérer qu’il comprenne qu’il devrait jouer sur votre bluff. Cela peut particulière fonctionner si vous êtes le Démon puisque vous connaissez 3 rôles qui ne sont pas en jeu. Par exemple, si vous déclarez être le Rêveur, et que votre Sbire est le <Role CRIEUR_PUBLIC /> ou le <Role FANG_GU />, votre déclaration de Rêveur peut être confirmée si le Sbire confirme être le <Role CRIEUR_PUBLIC />.
...
Chaque nuit, réveillez le Rêveur. Il désigne n’importe quel autre joueur. Si le joueur est un Villageois ou un Marginal, montrez son jeton de rôle et n’importe quel jeton de rôle de Sbire ou de Démon. Si le joueur choisi est un Sbire ou un Démon, montrez son jeton de rôle et n’importe quel jeton de rôle de Villageois ou de Marginal. Rendormez ensuite le Rêveur.
