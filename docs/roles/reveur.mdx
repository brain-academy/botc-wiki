...
> Le Rêveur choisit un joueur qui était le <Role FAUSSAIRE /> mais qui a pris la capacité du <Role FLEURISTE /> plutôt dans la nuit. Le Rêveur apprend que ce joueur est soit le <Role FAUSSAIRE />, soit le <Role VIGORMORTIS />.
