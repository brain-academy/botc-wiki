...
> Le <Role REVEUR /> choisit le joueur qui est le > Le <Role VORTOX />. L’information du > Le <Role REVEUR /> doit être fausse à cause du > Le <Role VORTOX /> alors le > Le <Role REVEUR /> apprend que ce joueur est soit l’> Le <Role ORACLE />, soit le > Le <Role NO_DASHII />.
