...
-   Un joueur gentil est considéré comme maléfique. Comme il est aussi considéré maléfique pour le Lycanthrope, il ne peut pas être tué par la capacité du Lycanthrope.
