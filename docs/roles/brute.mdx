...
- L’<Role HERBORISTE /> est à côté de la <Role BRUTE /> Gentille et de l’<Role INVENTEUR />. L'<Role INVENTEUR /> est exécuté et ne meurt pas. Le jour suivant, la <Role BRUTE /> devient Maléfique. L'<Role INVENTEUR /> est exécuté à nouveau et meurt.
