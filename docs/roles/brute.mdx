...
> Le <Role.SHABALOTH /> attaque la <Role.BRUTE />, puis la Commère. Comme le Shabalot devient ivre en ciblant la <Role.BRUTE />, il ne tue personne cette nuit et la <Role.BRUTE /> devient Maléfique. La nuit suivante, le <Role.SHABALOTH /> attaque le <Role.PARIEUR /> et la <Role.BRUTE />. Le <Role.SHABALOTH /> tue le <Role.PARIEUR /> et devient ivre en ciblant la <Role.BRUTE />. La <Role.BRUTE /> survit et reste Maléfique.

> La <Role.BONNE /> choisit la <Role.BRUTE /> et le Ménestrel, et obtient un “1” car la <Role.BONNE /> est ivre.
