...
Chaque fois qu’une capacité ne fonctionne pas correctement à cause d’une autre capacité, placez le jeton de rappel « Effet anormal » du mathématicien devant ce jeton de rôle.

Chaque nuit, réveillez le mathématicien. Montrez un nombre (0, 1, 2, etc…) avec doigts qui correspond au nombre de jeton de rappel « Effet anormal » placés dans le grimoire. Rendormez le mathématicien et retirez tous les jetons de rappel du mathématicien.
