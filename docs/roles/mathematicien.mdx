...
- Changez drastiquement votre information quand un changement évident dans le jeu devrait le provoquer. Par exemple, si une <Role DULCINEE /> meurt ou un qu’un <Role PHILOSOPHE /> choisit un rôle déjà en jeu, changez votre information en conséquence indiquera bien que vous êtes le Mathématicien et que la <Role DULCINEE /> et le <Role PHILOSOPHE /> disent bien la vérité.
