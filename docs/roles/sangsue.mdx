...
> La Sangsue empoisonne le <Role FERMIERE />. La Sangsue est rendue ivre par la <Role COURTISAN />. Le <Role FERMIERE /> empoisonné meurt et la partie continue car la Sangsue est aussi ivre. La Sangsue ivre est exécutée et meurt. Le village gagne.
...
- <Role FOU /> / <Role TISANIERE /> / <Role MARIN /> / <Role PACIFISTE /> / <Role AVOCAT_DU_DIABLE /> : Il n’y a pas de différence entre l’exécution de la Sangsue et une de ses capacités qui protège de la mort par exécution. Toutes ont pour résultat un joueur qui est exécuté mais qui ne meurt pas.
...
- <Role GALANTE /> / <Role GANGSTER /> / <Role VENGEUR /> : Ne peuvent pas tuer la Sangsue.