...
- Prêtez attention aux rôles qui ont des conditions de victoire ou de défaite et essayez de les déclencher. Si vous pouvez orchestrer l’exécution du <Role GOBELIN /> ou d’une jumelle gentil ou d’un deuxième gentil dans une partie de <Role LEVIATHAN />, votre victoire sera assurée. 

- Assurez-vous que le Conteur voit vos efforts. Etre un contributeur mineur à la défaite du village ne suffira pas. Assurez-vous que le Conteur a conscience que vous êtes le joueur le plus responsable de la défaite du village.

- Ne faites pas de remous sur le compte de Marginaux. S’il ne devrait y avoir qu’un Marginal en jeu et que quelqu’un prétend être le <Role RECLUSE />, ne le remettez pas en question. Restez caché et laissez le village dans le noir. Parfois, une seule fausse information sur le compte de Marginal peut suffire aux maléfiques pour l’emporter.

- Si le village semble sur une piste pour gagner, dévoilez-vous. Souvenez-vous que vous pouvez gagner avec le village également. L’information que pouvez fournir comme, quel joueur, probablement maléfique, suit votre plan machiavélique ; quel joueur a réagi au fait que vous prétendez être son rôle ou au fait que vous soyez Marginal peut être l’information manquante nécessaire pour gagner la partie.

- Essayez d’attirer l’attention des rôles qui détectent l’alignement (mais pas le rôle) dans votre stratégie. Convainquez une <Role COUTURIERE /> de vous choisir avec un joueur gentil confirmé ou une <Role SELENITE /> de vous choisir après sa mort. Rappelez-vous, vous êtes considéré comme gentil. Etre confirmé innocent aux yeux de ces rôles peut donner beaucoup de crédit à vos fausses informations. 

- Faites-en sorte que des rôles puissants à usage unique utilisent leur capacité sur vous. Convainquez un <Role MERCENAIRE /> de vous tirer dessus. Nominer une <Role IMMACULEE /> ou convainquez un <Role PROFESSEUR /> d’essayer de vous ressusciter. Les faire utiliser ces capacités puissantes sur un Politicien sape leurs efforts de rassembler des informations et de progresser. 
...
- <Role CONSPIRATEUR /> / <Role TOURMENTEUR /> / <Role LEVIATHAN /> : Si la partie se termine par un Prophète de l’effroi qui cible le Politicien ou en étant exécuté comme deuxième gentil dans une partie de Léviathan ou dans un jour joué grâce à la capacité du Conspirateur, le village perd. Si vous pensez que le Politicien est néanmoins le principal responsable de cette situation, le Politicien change de camp et gagne avec les maléfiques. Cela ne cause pas la défaite des maléfiques ensuite car le résultat de la partie et la condition de fin ont déjà été considérés. 

- <Role JUMELLE_MALEFIQUE /> : Il est rarement amusant de faire du Politicien la jumelle gentille car fera campagne pour sa propre exécution en ne mentionnant jamais être une des jumelles et gagner la partie avec les maléfiques de cette façon (et difficile de contredire qu’il était le plus responsable de cette victoire !)
...
- <Role GUENAUDE /> : jinx - "Si la Guenaude transforme un maléfique en Politicien, il ne peut pas redevenir gentil grâce à sa capacité."

- <Role VIZIR /> : Jinx - "Le Politicien peut être considéré comme maléfique pour le Vizir."

- <Role LEGION /> : Jinx - "Le Politicien peut être considéré maléfique pour la capacité de Legion." Politicien et Légion n’est pas une bonne combinaison car le Politicien est incité à voter sur toutes les éxécutions sauf la sienne et peut être le vote de gentil dont les Légions ont besoin pour assurer tous leurs votes. Là aussi, difficile de contredire qu’il était le plus responsable de cette victoire.
