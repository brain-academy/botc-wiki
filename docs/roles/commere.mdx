...
- Prenez vos informations avec du recul. Dans <Module BAD_MOON_RISING />, le cœur de l’enquête est d’identifier les causes des morts de nuit et ceci est plus compliqué qu’il n’y paraît. Entre un Démon pouvant attaquer plusieurs joueurs par nuit (<Role SHABALOTH />, <Role PO />), un Sbire pouvant tuer (<Role PARRAIN />, <Role ASSASSIN />) ou encore un rôle vulnérable de Gentil (<Role MAMIE />, Commère, <Role PARIEUR />, <Role BRICOLEUR />), de nombreuses interférences viennent complexifier le puzzle et vous ne pouvez jamais être certain que votre commérage a bien provoqué une mort de nuit. Il est également possible que vous soyez ivre ou empoisonné à cause du <Role MARIN />, de l’<Role AUBERGISTE /> ou du <Role PUKKA />.
