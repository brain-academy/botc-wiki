...
> Durant la première journée, le Jongleur déclare publiquement qu’Alex est le <Role CRIEUR />, Yann le <Role NO_DASHII /> et Julian le <Role SAGE />. La nuit suivante, le Jongleur a un « 2 » ce qui signifie que deux de ses propositions sont correctes.

> Durant la quatrième nuit, le <Role SAVANT /> est transformé en Jongleur. Le jour suivant, le Jongleur déclare publiquement que Pras est la <Role VIEILLE_CHOUETTE />, que Pras est la <Role SORCIERE /> et qu’Aude est la <Role VIEILLE_CHOUETTE />. La nuit suivante, le Jongleur a un « 1 ».
...
- Tout le monde ne voudra pas se dévoiler à vous. Les maléfiques seront parmi eux. Avoir confiance en son bluff le premier jour peut être difficile, en particulier pour les Sbires. Toutefois, les Marginaux (en particulier quelqu’un comme le <Role MALADROIT />) et des rôles comme l’<Role ORACLE /> ou le <Role CRIEUR /> seront aussi réticents car ils essayent de ne pas attirer l’attention du Démon sur eux. Cela vaut le coup d’être suspicieux sur quelqu’un qui ne veut pas se dévoiler mais cela ne le condamne pas automatiquement pour autant.
