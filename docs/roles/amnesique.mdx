...
-   Chaque jour, l’amnésique parle au conteur en privé et tente de deviner sa capacité. Le conteur répond « chaud » si le joueur est sur la bonne piste, « très chaud » si c’est très proche et « bingo » si c’est la capacité exacte.
...
- Quand vous tenter de deviner la nature de votre capacité, gardez en tête n'oubliez pas la variété de mécaniques à laquelle votre capacité pourrait être associée. Comme par exemple :
...
- « Devinez » tôt ou tard a chacun ses avantages. Comme vous mentez sur votre capacité, vous pourriez facilement rependre des mensonges dès que votre capacité est « devinée ». Toutefois, si vous devinez votre capacité si rapidement que cela semble irréaliste, vous pourriez attirer la suspicion sur vous.
...
_Rendez la capacité de l’amnésique devinable pour que l’amnésique ait une chance de trouver sa capacité avec le temps. Apprendre une information chaque nuit, ou une capacité qui affecte la partie suffisamment pour que l’amnésique le remarque sont de bonnes idées._
