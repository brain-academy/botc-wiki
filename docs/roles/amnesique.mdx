...
- Il est probablement meilleur de commencer par des questions larges comme « Est-ce ma capacité est lié aux Etrangers ? » et plus tard, basculer sur ces questions plus spécifiques comme « Est-ce que j'apprends si le joueur que j'ai choisis à un 'L' dans son rôle ? ».
