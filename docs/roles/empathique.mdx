...
- Faites attention au <Role.TRAITRE /> ! Il peut être vu comme gentil et du coup biaiser l’information que vous avez reçue. De même, l’<Role.ERMITE /> peut être vu maléfique, vous penserez alors être assis d’un maléfique, à vous de chercher les alignements.
 
### Bluffer l’<Role.EMPATHIQUE />
...
- Du fait que l’<Role.EMPATHIQUE /> soit un personnage important et puissant, cela paraîtra très suspect si vous êtes encore en vie à la fin de la partie. Jouez la “discret” et ne partagez vos informations qu’avec quelques personnes. Vous pouvez éventuellement prétendre que vous pensez être <Role.SOULARD />.
