...
- Annoncer que vous avez reçu un “1” alors que l'un de vos voisins est maléfique est risqué mais peut raporter gros. Si vous êtes une <Role CROQUEUSE_D_HOMMES /> et prétendez avoir un "1" alors que vous êtes assis à coté du <Role IMP /> ou vice versa peut faire croire au village que l'un d'entre vous est gentil et l'autre maléfique. Soyez prudents car le village pourrait décider de vous exécuter tous les deux.
