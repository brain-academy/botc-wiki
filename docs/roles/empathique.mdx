...
> Les deux voisins de l'Empathique sont des joueurs Gentils - un <Role SOLDAT /> et un <Role MOINE />. L'Empathique obtient alors "0" du Conteur.

> Le jour suivant, le <Role SOLDAT /> est exécuté. Durant la nuit, le <Role MOINE /> est tué par l’<Role IMP />. L'Empathique détecte maintenant les joueurs qui étaient assis à côté du <Role SOLDAT /> et du <Role MOINE /> : un <Role ARCHIVISTE /> et un <Role VENGEUR /> Maléfique. L’Empathique obtient alors cette fois "1".

> Il y a seulement trois joueurs en vie : l'Empathique, l’<Role IMP /> et le <Role BARON />. Peu importe les places, l'Empathique obtient alors "2".
...
- Si vos voisins meurent, vous recevrez une nouvelle information sur le joueur vivant le plus proche. Faire tuer vos voisins signifie que vous en apprenez plus. Si vous arrivez à vous coordonner avec un <Role CROQUE_MORT />, vous pouvez exécuter vos voisins pour avoir des informations sur les personnes suivantes. De son côté le <Role CROQUE_MORT /> pourra confirmer les rôles des personnes exécutées. C’est un combo très puissant. Même si vos voisins sont Gentils, cela peut valoir le coup d'exécuter un <Role MERCENAIRE /> qui a utilisé sa capacité pour également savoir si vous pouvez accorder du crédit à la <Role VOYANTE /> de l'autre côté du village.
...
- Du fait que l’Empathique soit un puissant rôle de détection, cela paraîtra très suspect si vous êtes encore en vie à la fin de la partie. Jouez-la "discret" et ne partagez vos informations qu’avec quelques personnes. Vous pouvez éventuellement prétendre que vous pensez être <Role SOULARD /> ou empoisonné.

### Comment conter ?

Chaque nuit, réveillez l’Empathique. Montrez-lui un nombre de doigts ("0", "1" ou "2") qui est égal au nombre de joueurs Maléfiques vivants voisins de l’Empathique. Rendormez l’Empathique.