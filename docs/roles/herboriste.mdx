...
Si vos deux voisins sont Gentils, ils ne peuvent pas mourir.
...
- Les voisins de l’<Role HERBORISTE /> sont la <Role MATRONE /> Gentille et le <Role MAGISTRAT /> Gentil. La <Role MATRONE /> peut être exilée mais ne peut pas mourir.
...
Si un joueur marqué « Protégé » devrait mourir, il reste en vie. Si un joueur marqué « Parrotégé » est exécuté, déclarez que ce joueur est exécuté mais qu’il ne meurt pas¨. (_Ne dites pas pourquoi._)