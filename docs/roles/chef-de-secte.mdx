...
> Le Chef de secte est voisin du <Role FERMIER /> et du <Role MAGICIEN />. La première nuit, le Chef de secte reste gentil. Le <Role MAGICIEN /> est exécuté et meurt et les nouveaux voisins du Chef de secte sont le <Role FERMIER /> et la <Role MARIONNETTE />. Le Conteur décide de passer le Chef de secte maléfiques. La nuit suivante, même si les voisins du Chef de secte sont toujours le <Role FERMIER /> et la <Role MARIONNETTE />, le Conteur décide de repasser le Chef de secte gentil.
