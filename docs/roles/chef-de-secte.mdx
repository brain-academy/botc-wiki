---
title: Chef de Secte (Cult Leader)
---

import * as Role from '/src/components/role/role-component'

<img src='/img/blood-on-the-clocktower/roles/chef-de-secte.png' height='150' />
...
> Kaina (<Role.CHEFDESECTE />) est assise entre Rémi (<Role.TRAITRE />) et Alex (<Role.ENQUETEUR />). En admettant que les voisins de Kaina restent vivants et donc qu’ils ne changent pas, le Conteur réveillera chaque nuit Kaina pour lui donner son alignement :

> Nuit 0 : Gentille (le Conteur a sélectionné Alex qui est <Role.ENQUETEUR />)

> Nuit 1 : Maléfique (le Conteur a sélectionné Rémi qui est <Role.TRAITRE />)

> Nuit 2 : Gentille (le Conteur a sélectionné Rémi qui est <Role.TRAITRE />, mais vu comme étant Gentil)
