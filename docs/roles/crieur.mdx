---
title: Crieur (Town Crier)
---

import * as Role from '/src/components/role/role-component'

<img src='/img/blood-on-the-clocktower/roles/crieur.png' height='150' />
...
- Un joueur tué par le pouvoir de la <Role.SORCIERE /> lors de sa nomination vous indiquera quand même si il était un Sbire ou non.
...
- Une fois que tous les”Sbires sont morts, n’accusez pas les Gentils d’être des Sbires. Dans le module “Sects & Violets”, les résultats des actions des Sbires sont publiques, comme la Vieille Chouette qui changent le rôle d’un joueur ou la <Role.SORCIERE /> qui tue les joueurs qui nominent. 
