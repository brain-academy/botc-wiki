...
> Caroline est le <Role.ERMITE /> et Manon est l’<Role.IMP />. L'enquêteur apprend qu’il y a l’<Role.EMPOISONNEUR /> parmi elles (le <Role.ERMITE /> peut être reconnu comme maléfique ou comme gentil, le Conteur décide. Ici, il est reconnu en tant que <Role.EMPOISONNEUR />)
