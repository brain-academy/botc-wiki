...
> Le <Role PROPHETE_DE_L_EFFROI /> et le <Role PSYCHOPATHE /> sont en jeu et sèment le chaos. L’Ingénieur choisit que le <Role MEZEPHELES /> et l’<Role ESPION /> sont en jeu. Le Conteur change le <Role PROPHETE_DE_L_EFFROI /> en <Role MEZEPHELES /> et le <Role PSYCHOPATHE /> en <Role ESPION />.

> L’Espion, l’<Role ASSASSIN /> et la <Role SORCIERE /> sont en jeu. L’Ingénieur choisit que l’<Role ESPION />, l’<Role ASSASSIN /> et le <Role MEZEPHELES /> sont en jeu. La <Role SORCIERE /> se transforme en <Role MEZEPHELES />.
