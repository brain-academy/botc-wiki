...
> La première nuit, l’Ingénieur change le <Role BARON /> en <Role BOOMDANDY />. Il y a toujours deux Etrangers en jeu.
...
- Ne craignez pas de créer des rôles qui ajoutent des Etrangers avec les capacités [entre crochets]. Ces parties-là indiquent au Conteur quels rôles ajouter ou retirer lors de la préparation de la partie et n’auront pas d’impact en cours de partie. Si vous créez un <Role BARON />, les deux Etrangers ne seront pas ajoutés.
...
- <Role PUKKA /> : Peut techniquement être considéré comme Sbire/Démon et être changé par l’Ingénieur ou affecter quels rôles sont changés… ne le faites juste pas, le Reclus est un Etranger. 
