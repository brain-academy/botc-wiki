...
> La deuxième nuit, l’Ingénieur choisit que le Démon est une <Role SANGSUE />. Sophie qui était le <Role IMP /> est maintenant la <Role SANGSUE />.

> La première nuit, l’Ingénieur change le <Role BARON /> en <Role BOOMDANDY />. Il y a toujours deux Marginaux en jeu.

> Le <Role PROPHETE_DE_L_EFFROI /> et le <Role PSYCHOPATHE /> sont en jeu et sèment le chaos. L’Ingénieur choisit que le <Role MEZEPHELES /> et l’<Role ESPIONNE /> sont en jeu. Le Conteur change le <Role PROPHETE_DE_L_EFFROI /> en <Role MEZEPHELES /> et le <Role PSYCHOPATHE /> en <Role ESPIONNE />.
...
- <Role PUKKA /> : Peut techniquement être considéré comme Sbire/Démon et être changé par l’Ingénieur ou affecter quels rôles sont changés… ne le faites juste pas, le Reclus est un Marginal. 
