...
- <Role LEGION /> : Jinxé – Si le chapelier et la légion sont en jeu, rien ne se passe. Si le chapelier meurt et qu’un maléfique choisit légion, tous les maléfiques actuels deviennent légion. 

- <Role LEVIATHAN /> : Jinxé –  Si le chapelier meurt le cinquième jour ou après, le démon ne peut pas choisir Léviathan.
