...
- <Role P_TIT_MONSTRE /> : Un p’tit monstre doit être capable de choisir un autre Démon comme d’habitude pour un Démon. Jinx : Si le Chapelier meurt et que le Démon choisit le P'tit Monstre, il choisit aussi un rôle de Sbire qu’il devient.
