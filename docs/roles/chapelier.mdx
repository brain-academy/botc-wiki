...
Le Chapelier permet aux Sbires et au Démon de changer de rôle.
...
> Le Chapelier meurt. L’<Role OJO /> choisit de devenir le <Role NO_DASHII /> et l’<Role AVOCAT_DU_DIABLE /> choisit de devenir la <Role SUCCUBE />.

> Le <Role VIGORMORTIS /> a tué sa <Role GUENAUDE /> puis, plus tard, tue le Chapelier. Les deux joueurs choisissent de garder leur rôle respectif donc les effets du <Role VIGORMORTIS /> ne sont pas perdus.
...
- <Role FOSSOYEUR /> : Le Fossoyeur apprend l’information qui était vraie au moment de l’exécution, peu importe si ce joueur exécute change de rôle entre temps.
...
- <Role DAMOISELLE /> : Même si les Sbires ont changé de rôle, un tentative utilisée le reste.
...
- <Role RECLUSE /> : Il est possible de réveiller la Recluse comme si c’était un Sbire ou un Démon pour lui permettre de changer de rôle mais c’est rarement amusant donc ce n’est pas recommandé.

- <Role INVOCATRICE /> : Jinx - "Si L'Invocatrice créé un deuxième Démon vivant, les morts de cette nuit sont arbitraires."

- <Role JUMELLE_MALEFIQUE /> : Si une Jumelle maléfique entre en jeu grâce au Chapelier, vous devriez réveillez chaque jumeau individuellement pour lui montrer qui est son jumeau et son rôle. Souvenez-vous que la jumelle gentille n’a pas nécessairement besoin d’être vivant et ne devrait généralement pas l’être si cela se produit en fin de partie car ça peut signifier que le village ne peut pas gagner.

- <Role PARRAIN /> : Si un Parrain entre en jeu, il apprend immédiatement les Marginaux qui sont en jeu que ces Marginaux soient vivants ou morts.

- <Role TOURMENTEUR /> : Si un joueur devient le Prophète de l’effroi, son choix fait avec son rôle précédent n’est pas pertinent pour l’annonce du Prophète de l’effroi, c’est son premier nouveau choix qui provoquera l’annonce, peu importe de qui il s’agit.
...
- <Role LEGION /> : Jinx – Si une Legion est créée, tous les maléfiques deviennent Legion. Si Legion est en jeu, le Chapelier n'a pas de capacité.

- <Role LEVIATHAN /> : Jinx –  "Le Leviathan ne peut pas rentrer en jeu après le 5ème jour."
...
- <Role TIMONSTRE /> : Un p’tit monstre doit être capable de choisir un autre Démon comme d’habitude pour un Démon. Jinx : Si le Chapelier meurt et que le Démon choisit le Timonstre, il choisit aussi un rôle de Sbire qu’il devient.
...
- <Role SSANGSUE /> : Une Ssangsue entrant en jeu doit immédiatement choisir un hôte et ensuite choisir qui tuer.

- <Role VIGORMORTIS /> : Un Démon qui change de Vigormortismortis à autre type alors qu’il a tué des Sbires pour maintenir leurs capacités provoquera la perte de ses capacités. Toutefois, si le Vigormortismortis reste en jeu, un Sbire tué par le Vigormortismortis peut changer de rôle et continuer à utiliser sa nouvelle capacité.
