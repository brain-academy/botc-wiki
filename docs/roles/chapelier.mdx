...
- <Role PTIT_MONSTRE /> : Un p’tit monstre doit être capable de choisir un autre démon comme d’habitude pour un démon. Jinx : Si un démon choisit le p’tit monstre, il choisit aussi un rôle de sbire qu’il devient et il garde le p’tit monstre.
