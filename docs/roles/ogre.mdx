...
- Si votre ami ne vous croit pas, persévérant. Assurez-le que vous dites la vérité et cherchez des rôles qui détectent l’alignement comme le <Role CUISTOT /> pour donner du crédit à votre argument.
...
- Choisissez qu’un de discret. Etre un ami n’est pas juste un terme de jeu. Les joueurs les plus discrets tendent à vouloir un ou deux joueurs à qui ils pourront faire confiance pour le reste de la partie à l’opposé de joueurs bruyants qui voudront plus de conversations et de schémas de confiance plus compliqués. Etre l’ami d’un joueur discret peut le faire vous protéger toute la partie. Sournois.
...
- Choisissez un joueur maléfique comme ami. C’est risqué car le village va penser que vous êtes dans la même équipe, même s’il ne sait pas de quel alignement vous êtes. Mais supposez cela peut mener le village a une impasse logique s’il pense que vous êtes tous les deux gentils. Assurez-vous que vos informations et celle de votre ami maléfique aient du sens. 
...
- Choisissez plusieurs personnes. Dites à chacune d’entre elles que vous êtes leur ami Ogre mais dites-leur aussi de ne rien dire à personne. Ça pourrait se retourner contre vous mais vous pourriez provoquez plusieurs mauvais votes dans le processus.
