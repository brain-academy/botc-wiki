...
- Engagez-vous fortement au joueur que vous prétendez avoir choisi. Engagez-vous auprès de votre « ami ». Si vous avez choisi l’<Role EMPATHE />, prétendez croire les informations de l’<Role EMPATHE /> toute la partie. Si vous avez choisi le <Role SAINT />, faites tout ce que vous pouvez pour que le village n’exécute pas le <Role SAINT />. Vous ne savez jamais quand votre « ami » sera prouvé comme gentil. Si vous choisissez la <Role BANSHEE />, par exemple, et que la <Role BANSHEE /> est tuée par le Démon la nuit, alors vous ne regretterez pas d’avoir été gentil et convaincant auprès de la <Role BANSHEE /> aussi en amont que possible.
...
- <Role RECLUSE /> : Jinx – «Si la Recluse est considérée comme maléfique pour l’Ogre, l’Ogre apprend qu’il est maléfique.»
...
- <Role GUENAUDE /> : Jinx – «Si la Guenaude transforme un maléfique en Ogre, il ne peut pas devenir gentil grâce à sa capacité.»