...
> La première nuit, l’Ogre choisit l’<Role INVOCATRICE />. L’Ogre devient maléfique et le reste pour le reste de la partie.
...
- <Role ESPIONNE /> : Jinx - "L'Espionne est considérée comme maléfique pour l'Ogre."

- <Role ESPIONNE /> / <Role VEUVE_NOIRE /> : L’Espionne et la Veuve Noire ne voit pas le joueur que l’Ogre a choisi mais peuvent voir l’alignement de l’Ogre.
