...
> Le troisième jour, le <Role PECHEUR /> apprend « Garde les joueurs qui se prétendent étrangers en vie ». Ces joueurs sont en réalité le <Role MALADROIT /> et le <Role PROPHETE_DE_L_EFFROI />. Le Conteur pense que garder ces joueurs en vie permettra plus probablement au village d’exécuter le Démon à la fin.
