...
- Donnez un faux conseil qui incrimine un joueur gentil. Utilisez le pour jeter de la suspicion sur les informations d’un <Role FOSSOYEUR />, d’une <Role VOYANTE /> ou pour faire exécuter un <Role VERTUEUX />.
