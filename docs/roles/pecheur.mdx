...
> Le troisième jour, le Pêcheur apprend « Garde les joueurs qui se prétendent Etrangers en vie ». Ces joueurs sont en réalité le <Role MALADROIT /> et le <Role PROPHETE_DE_L_EFFROI />. Le Conteur pense que garder ces joueurs en vie permettra plus probablement au village d’exécuter le Démon à la fin.

> C’est le troisième jour et le Pêcheur va voir le Conteur pour avoir son conseil. Le Conteur lui dit « Exécute Anthony » parce qu’Anthony est le <Role SOULARD /> et que le <Role CROQUE_MORT /> le découvrirais s’il est exécuté.

> C’est le dernier jour et le Pêcheur va voir le Conteur pour avoir son conseil. Le Conteur lui dit « Ne pose pas trop de questions à Sylvain » parce que Sylvain est la <Role BETE_DE_FOIRE /> et si sa capacité se déclenche, le village va perdre.
