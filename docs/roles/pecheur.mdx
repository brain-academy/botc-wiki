...
> Le Pêcheur apprend "3"Garde les joueurs qui prétendent être Marginal en vie." Ces joueurs sont secrètement le <Role MALADROIT /> et le <Role PROPHETE_DE_L_EFFROI />. Le Conteur pense que garder ces joueurs en vie va plus probablement se terminer avec une victoire du Village exécutant le Démon.
