...
> L'Intendant apprend qu'Alex est gentil. Alex est le <Role CROQUE_MORT />.

> La <Role VIEILLE_CHOUETTE /> transforme le <Role CULTIVATEUR_DE_PAVOT /> en Intendant. Cette même nuit, l'Intendant apprend que Jonathan est gentil. Jonathan est l'<Role ESPION /> mais considéré comme gentil. 
