...
> L'Intendant apprend qu'Alex est gentil. Alex est le <Role FOSSOYEUR />.

> La <Role VIEILLE_CHOUETTE /> transforme le <Role PLANTEUR_DE_PAVOT /> en Intendant. Cette même nuit, l'Intendant apprend que Jonathan est gentil. Jonathan est l'<Role ESPIONNE /> mais considéré comme gentil. 
...
- <Role RECLUS /> / <Role ESPIONNE />:  Le Reclus et l’Espionne pourrait ou ne pourraient pas être montrées à l’Intendant. C’est à l’appréciation du Conteur selon s’il est considéré comme gentil ou maléfique. 
