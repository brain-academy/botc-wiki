...
> L’Hérétique est mort. Le <Role SAINT /> est exécuté. Le village gagne.

> L’Hérétique est empoisonné. L’<Role ASSASSIN /> tue le Démon. Le village gagne.
...
- Essayer de trouver un joueur gentil comme la <Role COURTISAN /> qui peut vous rendre ivre ou empoisonné. Cela permettra au village de jouer la victoire sans la peur de perdre à la place.

- Prêtez attention aux rôles qui ont une capacité avec une condition de victoire ou de défaire comme le <Role MAIRE />, le <Role MALADROIT />, le <Role SAINT />, le <Role CONSPIRATEUR /> ou le <Role GOBELIN />. Si vous ne dites rien sur le fait d’être Hérétique, les maléfiques pourraient sans le savoir travailler à votre avantage. Par exemple, si le <Role GOBELIN /> est exécuté, le village gagne ou si un maléfique bluff le <Role MAIRE /> et convainc le village de ne pas exécuter le jour final, le village gagne. 
...
- Vous avez le sort de la partie entre vos mains. Peu de rôles ont ce pouvoir. Rappelez-vous à quel point vous êtes important. Tous les autres Villageois et Marginaux sont écrits d’une manière à dire « ce que vous voulez quand vous voulez » et que même des erreurs ne mettent pas fin à la partie. Par exemple, même si la <Role BETE_DE_FOIRE /> se dévoile et est exécutée, la partie continue. Même si la <Role VOYANTE /> se dévoile et meurt nuit 2, la partie continue. Mais l’Hérétique est différent. Les mots de l’Hérétique peuvent sceller drastiquement et brutalement le destin du village. Même si vous êtes un Marginal, vous êtes le joueur le plus dangereux de la partie pour les deux équipes.
...
- <Role AUBERGISTE /> / <Role COURTISAN /> / <Role MARIN /> / <Role MENESTREL /> / <Role DULCINEE /> / <Role EMPOISONNEUR /> / <Role VEUVE_NOIRE /> / <Role PUKKA /> : Si l’Hérétique est ivre/empoisonné quand la partie se termine, les conditions de victoires normales sont restaurées et s’appliquent.
...
- <Role PHILOSOPHE /> : Si le Philosophe choisit l’Hérétique et qu’il meurt, il garde la capacité car c’est une capacité qui s’applique « même si vous êtes mort ». Toutefois, un véritable Hérétique redeviendrait sobre à la mort du Philosophe donc il y a deux capacités d’Hérétique en jeu donc les conditions de victoires normales sont restaurées.
...
- <Role BARON /> : Jinx "Seul un des rôles jinxés peut être en jeu."

- <Role ESPIONNE /> / <Role PARRAIN /> / <Role VEUVE_NOIRE /> : "Seulement un rôle jinxé peut être en jeu."

- <Role JUMELLE_MALEFIQUE /> : La capacité de l’Hérétique est considérée après la fin de la partie sur une condition de victoire. Donc, une capacité de Jumelle maléfique empêche le village de mettre fin à la partie de gagner mais si une Jumelle maléfique met fin à la partie, l’Hérétique fait en sorte que le village gagne. Donc les maléfiques sont incités à tuer une jumelle afin de causer une victoire du village et donc d’avoir une victoire maléfique dans une partie d’Hérétique.

- <Role SCIENTIFIQUE /> : Jinx– 3Le Démon ne peut pas avoir la capacité de l’Hérétique.3

- <Role GUENAUDE /> : Jinx– “Une Guenaude ne peut pas créer un Hérétique.”

- <Role SSANGSUE /> : Jinx– "Seul un des rôles jinxés peut être en jeu."
