...
- Vous avez le sort de la partie entre vos mains. Peu de rôles ont ce pouvoir. Rappelez-vous à quel point vous êtes important. Tous les autres Villageois et Etrangers sont écrits d’une manière à dire « ce que vous voulez quand vous voulez » et que même des erreurs ne mettent pas fin à la partie. Par exemple, même si la <Role BETE_DE_FOIRE /> se dévoile et est exécutée, la partie continue. Même si la <Role VOYANTE /> se dévoile et meurt nuit 2, la partie continue. Mais l’hérétique est différent. Les mots de l’hérétique peuvent sceller drastiquement et brutalement le destin du village. Même si vous êtes un Etranger, vous êtes le joueur le plus dangereux de la partie pour les deux équipes.
...
- <Role BARON /> : Jinx "Le baron ne pourrait ajouter qu’un seul Etranger au lieu de deux."
