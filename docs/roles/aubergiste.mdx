...
- Si vos camarades maléfiques ont des bluffs qui ne marchent pas très bien, prétendez les avoir protégés. Cela en rendra un ,voire les deux comme potentiellement ivres ce qui leur donne une excuse pour le dysfonctionnement de leur capacité tout en donnant une explication sur pourquoi ils sont toujours en vie. 
