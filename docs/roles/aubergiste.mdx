...
> L’Aubergiste désigne le <Role FOU /> et la <Role FEMME_DE_CHAMBRE />. Le Conteur choisit de rendre le <Role FOU /> ivre. Le jour suivant, si le <Role FOU /> est exécuté, il meurt car sa capacité ne fonctionne pas correctement.
