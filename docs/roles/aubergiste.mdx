...
-   L’Aubergiste, comme le Moine, protège les joueurs de la mort par le Démon. Mais ils sont aussi protégés de la mort causée par des Marginaux, des Sbires, des Villageois et des Voyageurs.
...
> L’Aubergiste désigne le <Role FOU_DU_ROI /> et la <Role FEMME_DE_CHAMBRE />. Le Conteur choisit de rendre le <Role FOU_DU_ROI /> ivre. Le jour suivant, si le <Role FOU_DU_ROI /> est exécuté, il meurt car sa capacité ne fonctionne pas correctement.

> L’Aubergiste protège l’<Role ASSASSIN /> et le <Role PO />. Le Conteur choisit de rendre l’<Role ASSASSIN /> ivre. Plus tard durant la nuit, l’<Role ASSASSIN /> utilise sa capacité, mais rien ne se passe.

> L’Aubergiste se désigne lui-même ainsi que la <Role FEMME_DE_CHAMBRE />. Le Conteur choisit de rendre l’Aubergiste ivre. La <Role FEMME_DE_CHAMBRE /> est attaquée de nuit et décède.
...
- Ne vous ciblez pas vous-même. Cela n'est pas recommandé. Si un Aubergiste se cible lui-même, le Conteur choisit la plupart du temps de le rendre ivre par sa propre capacité, le rendant lui-même, ainsi que sur le second joueur choisi, vulnérables.

- Si vous pensez avoir trouvé deux maléfiques, sélectionnez-les. Même si cela les protègera de la mort, l’un des deux sera ivre jusqu’au crépuscule. Si vous mettez la main sur un Démon ou un Sbire puissant comme l’<Role ASSASSIN /> ou l’<Role AVOCAT_DU_DIABLE />, vous neutralisez des capacités de maléfiques à la source. Cependant, si vous vous trompez, vous pouvez être certain que le gentil sera ivre.

### Bluffer l’Aubergiste

- Si vous êtes le Démon, tuez des personnes différentes de celles que vous déclarez avoir protégées. Si vous vous êtes engagé à protéger la <Role FEMME_DE_CHAMBRE /> la nuit suivante et qu’on découvre sa mort au petit matin, vous allez devoir rendre des comptes. Si vous êtes un Sbire et que vous bluffez l’Aubergiste, arrangez-vous avec votre Démon pour qu’il tue d’autres personnes que celles que vous êtes censé protéger.

- Si vos camarades maléfiques ont des bluffs qui ne marchent pas très bien, prétendez les avoir protégés. Cela en rendra un, voire les deux, potentiellement ivres ce qui leur donne une excuse pour le dysfonctionnement de leur capacité tout en donnant une explication sur pourquoi ils sont toujours en vie. 
...
- Préparez un bluff de secours pour justifier le fait que vous soyez encore vivant à la fin de la partie. Un Aubergiste vivant le dernier jour est chose rare, mais pas impossible. Donnez une raison crédible d’avoir bluffé tout au long de la partie. Des rôles protégés, comme le <Role MARIN />, le <Role FOU_DU_ROI />, la <Role BRUTE /> ou encore les voisins de l’<Role TISANIERE />, cherchent tous à attirer le Démon et peuvent le faire en bluffant un rôle intéressant à tuer comme l’Aubergiste.
