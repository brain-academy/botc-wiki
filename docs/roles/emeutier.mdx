...
-   A partir du troisième jour, chaque joueur qui est nominé meurt immédiatement. Même s’il est mort, il peut nominer encore aujourd’hui.

-   Le joueur qui a été nominé doit nominer encore immédiatement ou perdre sa chance de le faire. Le Conteur décompte « 3…2…1 » pour que le joueur sache combien de temps il a pour nominer s’il le souhaite. S’il ne le fait pas, le Conteur nomine à sa place.

-   Le village gagne si tous les Emeutiers meurent. Si le dernier Emeutier et qu'il reste au moins deux autres en vie, ils ne nominent pas et le Village gagne.

-   Si personne ne nomine lors du troisième jour, le Conteur nomine en premier.

-   Les Sbires peuvent se transformer en Emeutier au début de la phase de nomination du troisième jour.
...
- Si vous voulez passer pour un joueur gentil, ne nominer pas le premier ou le deuxième jour. L’inconvénient est que vous ne tuez personne. Mais si vous bluffez un rôle qui a des informations cruciales pour les décisions que le village devra prendre comme la <Role VOYANTE /> ou le <Role CRIEUR_PUBLIC />, alors paraître digne de confiance peut entraîner des nominations entre gentils.

- N'ayez pas peur de mourir. Normalement, le Démon devrait rester en vie à tout prix. Quand vous êtes Emeutier, mourir n’est pas un si grand inconvénient tant que d’autres Emeutiers sont toujours en vie. Les Emeutiers conviennent particulièrement à des bluffs qui ont des effets qui affectent la partie quand ils meurent comme le <Role SAGE />, le <Role MALADROIT /> ou le <Role CORNEILLE />.
...
Durant la première journée, ajoutez le rappel « Jour 1 » au Grimoire. Le deuxième jour, ajoutez le rappel « Jour 2 » au Grimoire. Le troisième jour, ajoutez le rappel « Jour 3 » au Grimoire.

Durant la troisième nuit, réveillez les Sbires un à un et montrez-leur le jeton d’information « Tu es » puis le jeton de rôle d’Emeurtier. Rendormez les Sbires. Soit maintenant, soit plus tard durant la troisième journée, remplacez les jetons de rôles de Sbires par les jetons de rôle d’Emeutier.

Durant le troisième jour, chaque fois qu’un joueur est nominé, il meurt. Déclarez sa mort et ajoutez un linceul immédiatement. Dites-lui qu’il doit nominer un joueur vivant et comptez publiquement « 3…2…1… ». Après qu’il ait nominé, répétez ce processus jusqu’à ce que tous les Emeutiers soient morts ou qu’il ne reste que deux joueurs en vie. Déclarez quelle équipe est la gagnante. 

Si les joueurs ne nominent pas du tout lors du troisième jour ou si un joueur ne nomine pas avant la fin de son décompte, nominez un joueur à sa place. Il meurt et doit renominer à son tour.
...
- <Role ATHEE /> : jinx – « Lors d'une partie d'Emeutier, si le Conteur est nominé, les joueurs votent. S'il est exécutable, la partie se termine. Sinon, il nomine à son tour."

- <Role AUBERGISTE /> : jinx – « Si un Emeutier nomine et exécute un joueur protégé par l'Aubergiste, le Village gagne. »

- <Role BANSHEE /> : jinx – "Chaque nuit*, l'Emeutier choisit un joueur vivant gentil (différent des nuits précédentes) : Une Banshee choisie meurt et obtient sa capacité."

- <Role EXORCISTE /> : jinx - : « Si un Emeutier nomine et exécute un joueur choisi par l'Exorciste, le Village gagne. »

- <Role PHILOSOPHE /> : Premièrement, il n’est pas conseillé de mettre un Philosophe dans un script avec des Emeutiers sauf si vous êtes prêt à affronter les jinxs. Deuxièmement, soyez prudent avec les autres rôles que vous mettez dans le script si les Emeutiers et le Philosophe sont déjà dedans. Si vous insistez pour le faire quand même, voici la règle conseillée par les créateurs du jeu. Si le Philosophe choisit un rôle qui a un jinx « Seulement un rôle jinxé peut être en jeu. » et que le rôle « opposé » est déjà en jeu considérez que c’est l’usage unique du Philosophe et dites au Philosophe que ce rôle opposé est en jeu. Par exemple, avec des Emeutiers en jeu, le Philosophe choisi l’Exorciste. Il faudrait lui montrer le jeton de rôle de l’Emeutier, le rendormir et ne plus le réveiller. (Cela va probablement impliquer de dire à vos joueurs le fonctionnement de cette interaction avant que la partie ne commence car c’est une interaction peu ordinaire.) C’est parce qu’il ne peut pas gagner la capacité d’un rôle opposé à un rôle déjà en jeu sans que la partie ne soit « cassée » d’une certaine manière. Mais être capable de confirmer que les Emeutiers (ou Légion, ou quelconque autre rôle avec un jinx du type « les deux ne peuvent être en jeu ») sont ou ne sont pas en jeu est assez puissant et vaut probablement le prix d’une capacité à usage unique.

- <Role FERMIERE /> : « Chaque nuit*, l'Emeutier choisit un joueur vivant (différent des nuits précédentes) : Une Fermière choisi utilise sa capacité mais ne meurt pas. »

- <Role FOU_DU_ROI /> : Si nominé dans une partie d’Emeutiers, il utilise sa première vie mais doit toujours renominer derrière. (Mise en situation : Laurent nomine Zariko le fou, Zariko ne meurt pas, qui nomines-tu ?3…2…1… » ect…)

- <Role CORNEILLE /> : « Chaque nuit*, l'Emeutier choisit un joueur vivant (différent des nuits précédentes) : Une Corneille choisie utilise sa capacité mais ne meurt pas. »

- <Role TISANIERE /> : Si les deux voisins de la Tisanière sont gentils, ils ne peuvent pas mourir à cause d’une nomination mais ils doivent toujours nominer à nouveau.

- <Role LYCANTHROPE /> : N’empêche pas les morts durant le jour, seulement celles durant la nuit. 

- <Role MAMIE /> : Jinx - « Si un Emeutier est en jeu et que la descendance meurt par exécution, les Maléfiques gagnent. »
...
- <Role MOINE /> : Jinx – « Si un Emeutier nomine et exécute un joueur protégé par le Moine, le Village gagne. » 

- <Role PIXIE /> : Peut gagner sa capacité durant la journée et appliquer son effet avant même de se rendre compte qu’elle l’avait. Exemple : Un Pixie Tisanière qui protège immédiatement ses voisins gentils quand la Tisanière d’origine est nominé. Si le Pixie obtient une capacité de début de partie, grâce à une mort à cause des Emeutiers durant la journée, mais meurt le même jour, il ne sera pas réveillez la nuit suivante pour utiliser cette capacité gagnée.

- <Role IMMACULEE /> : Si l'Immaculée est nominée par un Villageois dans une partie avec Emeutiers, l'Immaculée meurt et le Villageois est immédiatement exécuté ce qui met fin à la journée.
...
- <Role DAMOISELLE /> : jinx – « Les Emeutiers sont des Sbires pour la Damoiselle. » Les Emeutiers apprennent qu’une Damoiselle est en jeu et n’importe quel Emeutier peut déclarer être Sbire et deviner qui est la Damoiselle.

- <Role SELENITE /> : Voir Maladroit
