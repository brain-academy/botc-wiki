...
> Le Charmeur de serpent choisit un joueur qui est la <Role GUENAUDE /> alors rien ne se passe. Le Charmeur de serpent se rendort simplement. La nuit suivant, le Charmeur de serpent se choisit lui-même alors rien ne se passe.
...
> La <Role GUENAUDE /> se transforme en Charmeur de serpent. Ensuite, ce nouveau Charmeur de serpent, choisit un joueur qui est le <Role FANG_GU />. Le Charmeur de serpent devient le <Role FANG_GU /> et le <Role FANG_GU /> devient le Charmeur de serpent empoisonné. Les deux joueurs restent maléfiques.
