---
title: Archiviste (Librarian)
---

import * as Role from '/src/components/role/role-component'

<img src='/img/blood-on-the-clocktower/roles/archiviste.png' height='150' />
...
> Tia (qui est <Role.SOULARD />) pense qu’elle est le <Role.MOINE /> et Lucy est le <Role.CROQUEMORT />. L’<Role.ARCHIVISTE /> apprend qu’entre Tia et Lucy se trouve le <Role.SOULARD /> (point mécanique : L’<Role.ARCHIVISTE /> apprend le vrai rôle du joueur, en l’occurence que Tia est le <Role.SOULARD />)
...
- Si vous obtenez un “0” du Conteur, cela signifie qu’il n’y a pas d’Etranger dans le Village. Par déduction, vous savez aussi qu’il n’y a pas de <Role.BARON />. Vous pouvez aussi pousser des joueurs à bluffer des rôles d’Etrangers pour les amener à se trahir !

- Vous pouvez utiliser les informations reçues durant la première nuit pour innocenter un joueur gentil et ainsi potentiellement bénéficier des informations qu’ils pourraient avoir de son côté si celui-ci a un rôle de détection comme l’Empatique ou le <Role.GARDIEN />.
