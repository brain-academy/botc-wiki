...
Lorsque vous mourez la nuit, un autre joueur gentil vivant devient un Fermier.
...
- <Role LEVIATHAN /> : Jinxé : Si le Léviathan est jeu et qu’un Fermier meurt par exécution, un joueur gentil Déviant un Fermier cette nuit.
...
- <Role EMEUTIER /> : Jinx : « Chaque nuit*, l'Emeutier choisit un joueur vivant (différent des nuits précédentes) : Un Fermier choisi utilise sa capacité mais ne meurt pas. »

- <Role LEVIATHAN /> : Jinx : « Chaque nuit*, le Léviathan choisit un joueur vivant (différent des nuits précédentes) : Un Fermier choisi meurt et obtient sa capacité. »
