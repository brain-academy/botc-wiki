...
> La deuxième nuit, le Fermier meurt. L’<Role CHORISTE /> devient le Fermier. La troisième nuit, le nouveau Fermier meurt à son tour alors l’<Role HERETIQUE /> devient Fermier. Il n’y a maintenant plus d’<Role HERETIQUE /> et d’<Role CHORISTE /> en jeu mais trois Fermier dont deux sont morts.
...
- <Role ESPIONNE /> : Peut être considéré comme gentil pour le Fermier.
