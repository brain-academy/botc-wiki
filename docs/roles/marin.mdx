...
- Choisissez des Villageois dont l’ivresse serait la moins préjudiciable. Une <Role MAMIE /> ou un <Role FOU /> ivre sera probablement moins nuisible au Village qu’un <Role EXORCISTE /> ou même une <Role COURTISAN /> ivre.
