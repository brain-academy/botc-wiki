...
Chaque nuit, choisissez 2 joueurs. Vous apprenez si l’un d’eux est le démon (Oui ; Non). Un des joueurs gentils est votre faux positif.
...
> La <Role VOYANTE /> choisit un <Role MAJORDOME />  en vie et un <Role IMP /> à présent mort, elle obtient un “OUI”.
...
- Si vous êtes la <Role CROQUEUSE_D_HOMMES />, vous pouvez accuser votre vrai Démon et faire tout pour qu’il soit exécuté. Cela permet à un éventuel <Role CROQUE_MORT /> de confirmer que vous avez exécuté le Démon et donc que vous êtes bel et bien la <Role VOYANTE /> !

- Si vous savez qu'il y a <Role RECLUS />, prétendez avoir eu un "OUI" sur lui. Si vous êtes <Role ESPION /> ou avez un <Role ESPION /> dans votre équipe, vous pouvez prétendre avoir eu un "OUI" sur le <Role RECLUS /> avant qu'il ne se dévoile ce qui donnerait du crédit à votre bluff.
...
_Dans les villages plus petits, faire de la voyante son propre faux positif est quelques fois conseillé car la voyante a de meilleures informations de cette façon._
