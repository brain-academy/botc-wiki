...
En préparant le Grimoire, retirez deux jetons de Villageois, et rajoutez deux jetons d’Etranger. (_Si vous ajoutez le Soûlard, pensez bien à appliquer les instructions associées._) Ces jetons de rôles d’Etrangers seront tirés par les joueurs à la place des jetons de Villageois.
