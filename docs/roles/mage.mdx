...
-   Le Mage n’est limité que par l’imagination du joueur. Ça peut être n’importe quoi. Le Mage peut écrire son vœu sur son téléphone et être réveillé la nuit par le Conteur ou parler en privé avec le Conteur pendant la journée. Le Mage peut même faire un vœu publiquement s’il se sent un peu fou.

-   Si le Conteur dit au groupe que le Mage a fait un vœu, il peut ne pas le faire immédiatement et peut le faire à n’importe quel moment ensuite.

-   Beaucoup de vœux ont un prix. Le prix change la partie d’une certaine manière ou change le vœu d’une certaine manière. Cela peut aussi être n’importe quoi. C’est décidé par le Conteur. Le Conteur peut informer ou ne pas informer le Mage du prix. Le but du prix est de rééquilibrer un vœu qui est injuste pour le village au niveau mécanique.
...
-   Quand le Mage meurt, le vœu peut ou ne peut pas être toujours en effet. Cela dépend de la nature du vœu et du prix.

-   Si le Mage fait un vœu que le Conteur ne comprend pas ou qu’il sent que ça serait impossible à implémenter, le Conteur peut demander au Mage de faire un nouveau vœu ou annuler le vœu.

### Exemples

> Le Mage souhaite voir le Grimoire. Le Conteur exauce ce vœu sans prix et sans indices.

> Le Mage souhaite que tous les joueurs gentils soient ivres. Le Conteur exauce ce souhait. Plus tard, il déclare que le Mage a fait un vœu et que « les choses ne marchent pas » mais ne donne pas plus de contexte. Pour le reste de la partie, le Conteur rend toutes les informations fausses.

> Le Mage souhaite devenir un Démon. Le Conteur exauce ce vœu. Plus tard, il déclare que le Mage a fait un vœu et que « l’élève a dépassé le maître. » Le Conteur tue le <Role SEIGNEUR_DE_TYPHON /> et transforme le Mage en <Role OJO />.

> Le Mage souhaite de gagner la partie. Le Conteur exauce ce souhait et dit au Mage que les maléfiques gagneront la partie à la fin de la journée. Le Conteur déclare que le Mage a fait un vœu et que Simon, Léonard ou Mathis est le Démon. Le village exécuté Simon qui est le Démon et le village gagne.

> Le Mage souhaite que tous les joueurs aient 5 vies et que tous les jetons de rappels du script soient placés sur les rôles. Le Conteur juge que ce vœu est trop bizarre, confus et ennuyant. Il refuse ce vœu et demande au Mage de faire un autre vœu. 
...
- Avant de jouer un script avec le Mage, réfléchissez à des choses que vous pourriez souhaiter si jamais vous avez le rôle ! Cela peut rendre les choses moins stressantes pour le Mage car il n’y aura pas de pression à faire un vœu sur le moment.
...
- Attendez-vous à ce que le Conteur déclare que le Mage a fait un vœu ou à ce qu’il fasse une annonce « inattendue ». Feignez la surprise à l’annonce qu’un Mage est en jeu pour que les autres joueurs ne puissent pas identifier que vous saviez ce qui allait arriver.

- Aidez les joueurs gentils à déterminer ce que signifie l’indice. Si on dirait que vous essayez vraiment de « résoudre » ce qu’il se passe avec le vœu du Mage, les gentils vous feront probablement plus confiance et pourraient croire que vous dites la vérité.

- Prétendez aider les autres joueurs gentils à déterminer ce que l’indice signifie mais mener les secrètement dans la mauvaise direction. Si on dirait que vous essayez vraiment de « résoudre » ce qu’il se passe avec le vœu du Mage et que vous trouvez une explication alternative, cela envoie le village dans la mauvaise direction et ils passeront plus de temps à parler de vos inepties et moins de temps à discuter de qui est le Démon.

- Si ça ne vous dérange pas que le village devine ce qu’est le souhait, attirez l’attention sur ce que pourrait avoir souhaité le Mage. Il est difficile pour les joueurs de deviner à la fois quel est le vœu et qui est le Démon donc s’ils passent tous leurs temps à deviner quel est le vœu, ils passent moins de temps à cherche le Démon.
...
- Restez simple. Des vœux simples peuvent rester incroyablement forts, en particulier s’ils sont formulés au bon moment. Les parties les plus excitantes et amusantes ont étés des parties où le Mage a souhaité que tout le monde ait la capacité de l’<Role BRICOLEUR /> ou de souhaiter que « le Conteur annonce que le vœu du Mage a été exaucé ».
...
- Faites attention aux choses inhabituelles que le Conteur dit ou fait. Ce sont probablement des indices provoqués par le vœu du Mage et peut être utile quand vous essayez de comprendre ce qu’il s’est passé.
    -	Utilisez les indices à votre avantage ! Si le Conteur dit « Il y a une capacité d’<Role BRICOLEUR /> en jeu », jouez comme si vous pouviez mourir à tout moment. Si votre rôle change, trouvez d’autres joueurs qui ont aussi changé de rôle. Parlez de ce que vous voyez ou découvrez et essayez d’identifier ce que l’indice peut vous dire.
...
- Faites confiance en votre Conteur pour fixer un prix adéquat ou un indice approprié pour le vœu du Mage.
    -	Si vous pensez que le Conteur n’a pas équilibré le vœu du Mage équitablement, signalez-le en privé à la fin de la partie.
...
_Globalement, le vœu devrait faire pencher la balance en faveur du Mage tout en laissant au village des chances raisonnables de victoire. Prenez votre temps pour décider de comment faire cela._