...
Si elle désigne deux joueurs, soit vous faites « oui » de la tête (_pour indiquer que ces joueurs sont du même alignement_) ou faites « non » de la tête (_pour indiquer que ces joueurs ne sont pas du même alignement_). Rendormez la couturière. Elle n'a plus de capacité, placez le jeton de rappel « Utilisé » devant son jeton de rôle et retiré son jeton de nuit de la feuille d'ordre de nuit.