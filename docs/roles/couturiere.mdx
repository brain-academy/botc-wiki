...
> La <Role GUENAUDE /> transforme le <Role MATHEMATICIEN /> en <Role SORCIERE /> qui reste gentille. Plus tard dans la nuit, la Couturière choisit deux joueurs qui sont cette <Role SORCIERE /> et le <Role CRIEUR />. La Couturière reçoit un "Oui" car les deux sont gentils.
