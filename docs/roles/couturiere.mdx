...
> Durant la première nuit, la Couturière choisi deux joueurs qui sont le <Role BARBIER /> et l'<Role HORLOGER />. Comme ils sont tous les deux gentils, la Couturière a un "Oui".
...
> La <Role VIEILLE_CHOUETTE /> transforme le <Role MATHEMATICIEN /> en <Role SORCIERE /> qui reste gentille. Plus tard dans la nuit, la Couturière choisit deux joueurs qui sont cette <Role SORCIERE /> et le <Role CRIEUR />. La Couturière reçoit un "Oui" car les deux sont gentils.
