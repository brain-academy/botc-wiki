...
- <Role MEDECIN_DE_PESTE /> : Jinx - "Si le Démon a un voisin vivant qui est Villageois ou Etranger quand le Médecin de peste meurt, ce joueur devient une Marionnette maléfique. S'il y a déjà un joueur devenu maléfique, ceci ne se produit pas."
...
- <Role SPECTRE /> : Jinx - "Le Spectre ne se réveille pas avec la Marionnette."
