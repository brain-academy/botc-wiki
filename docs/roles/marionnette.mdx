...
-   La Marionnette n'est pas réveillée par les capcités qui lui prouverait qu'elle est la Marionnette (Balance, Prédicateur, P'tit Monstre, Planteur de Pavot, Chapelier, Damoiselle)
...
- <Role FOSSOYEUR /> / <Role FILLE_DE_JOIE /> / <Role GARDIEN /> / <Role REVEUR /> : Voit la Marionnette qui est le véritable rôle du joueur.
