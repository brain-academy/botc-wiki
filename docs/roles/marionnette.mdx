...
- <Role MATHEMATICIEN /> : Jinx - "Le Mathématicien pourrait apprendre que la capacité que la Marionnette croit avoir a généré de fausses informations ou n'a pas correctement fonctionné."
