...
- <Role MEDECIN_DE_PESTE /> : Jinx - "Si le Démon a un voisin vivant qui est villageois ou étranger quand le medecin de peste meurt, ce joueur devient une marionnette maléfique. S'il y a déjà un joueur devenu maléfique, ceci ne se produit pas."
