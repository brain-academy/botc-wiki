...
-   La Marionnette tire un jeton de rôle de Villageois ou de Marginal mais est en réalité la Marionnette.
...
-   La capacité de gentil que pense avoir la Marionnette ne fonctionne pas mais le Conteur lui fait croire qu'elle fonctionne. C'est comme avec l'Ivrogne.

-   La Marionnette est considérée comme maléfique et comme Sbire.

-   La Marionnette n'est pas réveillée par les capcités qui lui prouverait qu'elle est la Marionnette (Balance, Prédicateur, Timonstre, Planteur de Pavot, Chapelier, Damoiselle)

### Exemples

> Sylvain est la Marionnette mais pense être le <Role FOSSOYEUR />. Il se réveille chaque nuit pour apprendre qui a été exécuté mais son information est souvent fausse. En milieu de partie, le Démon lui dit qu’il est la Marionnette. 
...
-	En tant que Marionnette vous êtes essentiellement un <Role IVROGNE /> maléfique. Non seulement vous n’avez pas la capacité que vous pensiez avoir mais vous n’avez pas non plus l’alignement que vous pensiez avoir ! La bonne nouvelle, c’est que la plupart des techniques pour détecter un <Role IVROGNE /> marcheront aussi pour la Marionnette. Si vos informations ne collent pas avec celles des autres ou que votre capacité ne fonctionne pas comme elle le devrait, vous pourriez être la Marionnette au lieu d’être un gentil. 

-	Même si vous ne le savez pas, votre alignement est maléfique et vous serez considéré comme maléfique pour des rôles comme la <Role COUTURIERE /> ou le <Role CRIEUR_PUBLIC />. Vous pouvez utiliser cela pour vous aider à découvrir votre identité… Mais le village le peut aussi, alors, soyez prudent avant de demander à des joueurs d’utiliser leurs capacités sur vous.
...
- De la même manière que vous chercheriez un <Role IVROGNE /> dans trouble brewing, cherchez un joueur qui donne de fausses informations, même de façon convaincante. Si l’information d’un joueur ne particulier ne colle pas, vous avez peut-être trouvé la Marionnette. Par exemple, si un joueur déclare être l’<Role EMPATHE /> avec un « 0 » mais que vous suspectez un de ses voisins d’être maléfique, l’<Role EMPATHE /> pourrait être la Marionnette.
...
- Normalement, trouvez qu’un joueur est un Sbire est utile mais ne fera pas gagner la partie au village. Le jour final, apprendre qu’un joueur mort depuis longtemps était le Conspirateur est pratique mais apprendre qu’un joueur mort depuis longtemps était la Marionnette est incroyablement utile. Même avec une <Role GUENAUDE /> en jeu qui a changé des rôles ou un <Role PUKKA /> qui a semé le doute sur les informations de tout le monde, la simple information qu’un joueur est spécifiquement la Marionnette devrait suffire à faire gagner le village une fois qu’il n’y a plus que 3 joueurs en vie.
...
Traitez la Marionnette comme si c’était un Ivrogne. Il se réveille quand son rôle de gentil devrait se réveiller et pourrait avoir de fausses informations. Ne la réveillez pas durant la phase d’information des Sbires, etc. 
...
- <Role ALCHIMISTE /> : Jinx: " Un Alchimiste Marionnette n’a pas la capacité de la Marionnette et la Marionnette est en jeu."

- <Role AERONAUTE /> : Jinx: "Si la Marionnette pense être l’Aéronaute, +1 Marginal a pu être ajouté."
...
- <Role CHARMEUR_DE_SERPENT /> / <Role BARBIER /> / <Role GUENAUDE /> / <Role FANG_GU /> / <Role IMP /> / <Role TIMONSTRE /> / <Role MATRONE /> : Si le Démon change en cours de partie, cela n’affecte pas la Marionnette. Son placement à côté du Démon s’applique à la préparation du Grimoire et n’a pas d’effet plus tard dans la partie. Par contre, on indique au nouveau Démon qui est la Marionnette.

- <Role CHASSEUR /> : "Si la Marionnette pense être le Chasseur, la Damoiselle a été ajoutée."
...
- <Role MATHEMATICIEN /> : Jinx - "Le Mathématicien apprend si la capacité de la Marionnette a généré une fausse information ou n'a pas fonctionné."

- <Role MAGICIEN /> : La Marionnette ne peut pas être à côté du Magicien à la place du Démon. Les Sbires pensent seulement que le Magicien est le Démon mais le Magicien n’est pas considéré comme Démon. Toutefois, un Magicien à côté du Démon peut être la Marionnette du Démon. Jinx : "Si le Magicien est vivant, le Démon ne sait pas lequel de ses voisins est la Marionnette."
...
- <Role MEDECIN_DE_PESTE /> : Jinx - "Si le Conteur gagnerait la capacité de la Marionnette, un des voisins gentils du Démon devient la Marionnette."

- <Role RECLUSE /> : La Marionnette peut être voisine du Recluse qui est alors considéré comme demon ! Techniquement, vous pouvez aussi dire au Recluse qui est la Marionnette mais ça serait vendre un joueur qui ne saît même pas qu’il est maléfique à un joueur gentil. Donc il est probablement mieux de quand même dire au vrai Démon qui est la Marionnette ce qui ajoute aussi le plaisir de dire au Démon qu’un des joueurs voisins de la Marionnette doit être la Recluse.

- <Role INVOCATRICE /> : Jinx : « Si une Marionnette devait être en jeu, elle entre en jeu après le Démon et doit commencer en étant son voisin.»

- <Role GUENAUDE /> : Si un joueur gentil est transformé en Marionnette au cours de la partie, il devient essentiellement un Ivrogne. Vous pouvez continuer à le traiter comme s’il était ce rôle qu’il pense encore être mais il serait empoisonné à partir de maintenant. Vous pouvez avoir la même attitude que s’il avait été transformé en Ivrogne et choisir de lui dire qu’il a été changé en un autre rôle à la place si vous le souhaitez.
...
- <Role KAZALI /> : Jinx : « Si une Marionnette devait être en jeu, elle entre en jeu après le Démon et doit commencer en étant son voisin."
...
- <Role TIMONSTRE /> : Jinx : « Si une Marionnette devait être en jeu, elle entre en jeu après le Démon et doit commencer en étant son voisin.»
...
- <Role BARISTA /> : L’information sobre et saine a le même résultat qu’une Marionnette ivre. A vous de choisir si vous pensez qu’un Ivrogne affecté par le Barista peut toujours avoir des informations arbitraires ou non. Assurez-vous simplement de dire à vos joueurs comment vous gérez cette interaction si vous ajoutez un Barista au village avec une Marionnette ou un Ivrogne sur le script.
