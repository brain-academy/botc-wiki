...
> L'Apprenti maléfique acquiert la capacité de l'<Role ASSASSIN />. Cette nuit-là, il tue le <Role FOU_DU_ROI />. 

> L'Apprenti gentil acquiert la capacité de la <Role FEMME_DE_CHAMBRE />. À partir de maintenant, il apprend qui se réveille la nuit. Plus tard, le <Role PARIEUR /> pari que l'Apprenti est l'<Role TISANIERE />. Le <Role PARIEUR /> meurt, car l'Apprenti n'est pas l'<Role TISANIERE />, mais bien l'Apprenti. 
