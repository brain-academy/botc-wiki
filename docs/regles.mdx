...
**Lorsqu'elles sont utilisées, les capacités fonctionnent immédiatement.** Par exemple, si le Démon attaque la <Role VOYANTE/>, elle meurt immédiatement, celle-ci ne peut pas se réveiller plus tard dans la nuit pour utiliser sa capacité. Ou si le <Role MOINE/> se réveille et protège l'<Role EMPATHIQUE/>, et que peu de temps après, le Démon se réveille et attaque l'<Role EMPATHIQUE/>, celui-ci ne meurt pas.

**Dites seulement au joueur ce qu’il doit savoir par rapport à la capacité de son rôle.** Les secrets sont secrets. Si l’<Role IMP/> meurt et que la <Role CROQUEUSE_D_HOMMES/> devient le nouvel <Role IMP/>, les autres joueurs doivent-ils apprendre que cela s'est produit ? Non. Si le <Role MERCENAIRE/> utilise sa capacité et que rien ne se passe, les joueurs apprennent-ils que le <Role MERCENAIRE/> est le <Role MERCENAIRE/> ? Non. Si le <Role MOINE/> protège la <Role LAVANDIERE/>, la <Role LAVANDIERE/> sait-t-elle qu'elle était protégée ? Non. Quand la nuit se termine, les joueurs apprennent-ils quelle capacité a tué quel joueur ? Non, ils prennent seulement connaissance des joueurs morts mais pas de la façon dont ils sont morts.
...
**Les capacités utilisées sur un joueur ivre ou empoisonné fonctionnent normalement.** Par exemple, un <Role EMPATHIQUE/> apprend correctement l'alignement de ses voisins ivres. Une <Role VOYANTE/> identifie correctement un Démon empoisonné. Si la <Fabled DUCHESSE/> - un rôle Légendaire qui accorde de l’information à trois joueurs - est visitée par un <Role MERCENAIRE/> empoisonné alors le <Role MERCENAIRE/> obtient de l’information vraie. Dans ce cas, la capacité de la <Fabled DUCHESSE/> fonctionne correctement même si la capacité du <Role MERCENAIRE/> ne fonctionne pas.
