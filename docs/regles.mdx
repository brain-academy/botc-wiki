...
Le processus d'exil d'un Voyageur n'est pas affecté par les capacités. C'est purement une décision du Village. Par exemple, les rôles qui modifient les votes (<Role VOLEUSE/>, <Role BUREAUCRATE/>, etc.) ne modifient pas la prise en charge de l'exil. Même le <Role MAJORDOME/> peut lever la main pour soutenir un exil sans que son maître lève sa main.
