...
Il peut aussi être utile de considérer quels autres rôles et interactions sont sur le script. S’il y a un <Role FANG_GU/>, par exemple, et que le Démon est le seul rôle qui peut causer une mort de nuit, alors, tuer un Etranger la nuit va éloigner le village de la piste du <Role FANG_GU/>.
