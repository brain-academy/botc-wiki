...
- Si vous ajoutez un <Role ESPION />, n'ajoutez pas une <Role LAVANDIERE /> / un <Role GARDIEN /> / un <Role FOSSOYEUR /> pour que l'<Role ESPION /> ait l'opportunité de prétendre être un de ses rôles et de confirmer un autre maléfique comme Athée.
