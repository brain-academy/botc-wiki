...
<Role FAUSSAIRE /> / <Role VIEILLE_CHOUETTE /> : Si une capacité d’athée entre en jeu en cours de partie, le contour pourrait briser les règles et s’il est exécuté, le village gagne. Cela ne retire pas les maléfiques en jeu.
