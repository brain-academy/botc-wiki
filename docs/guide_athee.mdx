...
- Si vous ajoutez un <Role ESPIONNE />, n'ajoutez pas une <Role LAVANDIERE /> / un <Role CORNEILLE /> / un <Role FOSSOYEUR /> pour que l'<Role ESPIONNE /> ait l'opportunité de prétendre être un de ses rôles et de confirmer un autre maléfique comme Athée.
