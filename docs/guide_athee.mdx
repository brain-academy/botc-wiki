...
-	L’Athée est considéré comme maléfique et comme Sbire ou Démon pour la <Role VOYANTE />, l’<Role ENQUETEUR />, le <Role GARDIEN />, l’<Role EMPATHIQUE />, le <Role MERCENAIRE />, la <Role PUCELLE />. L’Athée n’est pas considéré comme gentil ou comme Villageois ou Marginal pour la <Role LAVANDIERE /> ou l’<Role ARCHIVISTE />.
