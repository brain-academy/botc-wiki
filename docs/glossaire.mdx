...
**Classe** : Une classe de rôle : Villageois, Marginal, Sbire, Démon, Voyageur ou Légendaire. 
...
**Marginal** : Une classe de rôle qui commence la partie avec un alignement gentil. Les Marginaux ont des capacités qui ne sont d'aucune utilité pour l’équipe des gentils. La feuille des Voyageurs indique le nombre de Marginaux dans la partie en cours.
...
**Feuille d’ordre de nuit** : La feuille que le Conteur utilise pour savoir quels rôles agissent dans quel ordre la nuit. La feuille de nuit a un côté à utiliser pour la première nuit et un autre côté à utiliser pour toutes les autres nuits. 
...
**Jeton de mort (Linceul)**: Les jetons en forme de bannière noire et grise utilisés dans le Grimoire pour indiquer qu'un joueur est mort.
...
**Jeton de vote** : Le petit jeton rond blanc qui est placé sur le jeton de vie d'un joueur lorsqu'il meurt. Lorsque ce joueur mort vote, il enlève son jeton de vote et ne peut pas voter pour le reste de la partie.
...
Cette étape est reliée à la classe Démon et n’est pas en lien avec l’activation d’une capacité. 
...
Cette étape est reliée à la classe Sbire et n’est pas en lien avec l’activation d’une capacité. 
...
**Maléfique** : L'alignement maléfique. Les Sbires et les Démons (rôles rouges) commencent comme maléfiques. Le mal gagne quand seulement 2 joueurs sont en vie, sans compter les Voyageurs.
...
**Nomination** : L'acte de déclencher un vote du Village pour demander l’exécution d’un joueur, qui est repris par le Conteur. Les joueurs peuvent nominer un joueur une fois par jour, et peuvent être nominés une fois par jour. Seuls les joueurs vivants peuvent proposer une nomination.
...
**Rôle bon** : Villageois ou Marginaux.
