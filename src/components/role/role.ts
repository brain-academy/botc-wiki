...
export class Villageois extends Role implements Good {
    ...
    static readonly CHASSEUR = new Villageois({name: 'Chasseur', originalName: 'Huntsman', wakeUpSchedule: 'UNTIL_ABILITY_CONSUMED'})
    ...
    static readonly CULTIVATEUR_DE_PAVOT = new Villageois({name: 'Cultivateur de pavot', filename: 'cultivateur-de-pavot', originalName: 'Poppy Grower'})
    static readonly EMPATHIQUE = new Villageois({name: 'Empathique', originalName: 'Empath', class: 'DETECTION', wakeUpSchedule: 'EVERY_NIGHT'})
    static readonly ENFANT_DE_CHOEUR = new Villageois({name: 'Enfant de choeur', filename: 'enfant-de-choeur', originalName: 'Choirboy', wakeUpSchedule: 'Si le roi est tué par le démon'})
    ...
    static readonly FERMIER = new Villageois({name: 'Fermier', originalName: 'Farmer'})
    ...
    static readonly INGENIEUR = new Villageois({name: 'Ingénieur', filename: 'ingenieur', originalName: 'Engineer', wakeUpSchedule: 'UNTIL_ABILITY_CONSUMED'})
    ...
    static readonly LYCANTHROPE = new Villageois({name: 'Lycanthrope', originalName: 'Lycanthrope', wakeUpSchedule: 'EVERY_NIGHT_BUT_FIRST'})
    static readonly HERBORISTE = new Villageois({name: 'Herboriste', originalName: 'Tea Lady', class: 'PROTECTION'})
    static readonly MAGICIEN = new Villageois({name: 'Magicien', originalName: 'Magician'})
    ...
    static readonly NOBLE = new Villageois({name: 'Noble', originalName: 'Noble', wakeUpSchedule: 'FIRST_NIGHT'})
    ...
    static readonly PIXIE = new Villageois({name: 'Pixie', originalName: 'Pixie', wakeUpSchedule: 'FIRST_NIGHT'})
    ...
    static readonly ROI = new Villageois({name: 'Roi', originalName: 'King', wakeUpSchedule: 'Si le nombre de mort est strictement supérieur au nombre de vivants'})
    ...
    static readonly VEILLEUR_DE_NUIT = new Villageois({name: 'Veilleur de nuit', filename: 'veilleur-de-nuit', originalName: 'Nightwatchman', wakeUpSchedule: 'UNTIL_ABILITY_CONSUMED'})
...
export class Demon extends Role implements Evil {
    ...
    static readonly LEGION = new Demon({name: 'Légion', filename: 'legion', originalName: 'Legion'})
...
export class Voyageur extends Role {
    ...
    static readonly BUREAUCRATE = new Voyageur({name: 'Bureaucrate', originalName: 'Bureaucrat', wakeUpSchedule: 'EVERY_NIGHT'})
    ...
    static readonly ARCHEVEQUE = new Voyageur({name: 'Archevêque', filename: 'archeveque', originalName: 'Bishop'})
    ...
    static readonly BOUCHER = new Voyageur({name: 'Boucher', originalName: 'Butcher'})
    static readonly COLLECTEUR_D_OS = new Voyageur({name: 'Collecteur d\'os', filename: 'collecteur-d-os', originalName: 'Bone collector', wakeUpSchedule: 'UNTIL_ABILITY_CONSUMED'})
    static readonly DEVIANT = new Voyageur({name: 'Déviant', filename: 'deviant', originalName: 'Deviant'})
    static readonly FILLE_DE_JOIE = new Voyageur({name: 'Fille de joie', filename: 'fille-de-joie', originalName: 'Harlot', wakeUpSchedule: 'EVERY_NIGHT_BUT_FIRST'})
    static readonly GANGSTER = new Voyageur({name: 'Gangster', originalName: 'Gangster'})
...
export class Legendaire extends Role {
    ...
    static readonly BIBLIOTHECAIRE = new Legendaire({name: `Bibliothécaire`, filename: 'bibliothecaire', originalName: 'Hells Librarian'})
    ...
    static readonly REVOLUTIONNAIRE = new Legendaire({name: `Révolutionnaire`, filename: 'revolutionnaire', originalName: 'Revolutionnary'})
    ...
    static readonly MAUVAIS_GENIE = new Legendaire({name: `Mauvais génie`, filename: 'mauvais-genie', originalName: 'Djinn'})
    ...
    static readonly CHASSEUR_D_ORAGE = new Legendaire({name: `Chasseur d'orage`, filename: 'chasseur-d-orage', originalName: 'Storm Catcher'})
}
