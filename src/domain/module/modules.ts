...
export const Modules: {
    ...
    TROUBLE_BREWING: {
        ...
        gameplay: `
            ...
            Quelques Villageois obtiennent de l'information en accomplissant une action et en observant son effet : sacrifier la vie d'un joueur en lui demandant de nominer l'Immaculée, tenter de tuer l’Imp en tant que Mercenaire ou tuer délibérément des Gentils pour que le Fossoyeur puisse confirmer leur identité. Ce sont toutes des façons de sacrifier sa vie ou sa capacité pour obtenir de l'information et atteindre la victoire.
        ...
        detail:`
            ...
            3) Lavandière, Mercenaire, Immaculée, Fossoyeur, Voyante, Reclus, Espionne et Imp. Il s'agit d'une configuration plus avancée, nécessitant une logique plus approfondie de la part des joueurs, mais elle peut être très gratifiante s'ils la comprennent. N'oubliez pas que la Recluse peut s'enregistrer en tant que Démon auprès de la Voyante, du Fossoyeur et du Mercenaire ! Et rappelez-vous que l’Espionne peut s’enregistrer en tant que Villageois auprès de l'Immaculée, du Croque- mort et de la Lavandière !
`
    },
    BAD_MOON_RISING: {
        ...
        roles: [
            ...
            Roles.SBIRES.AVOCAT_DU_DIABLE,
            Roles.SBIRES.ASSASSIN,
            Roles.SBIRES.CONSPIRATEUR,
            Roles.DEMONS.PUKKA,
            Roles.DEMONS.PO,
    ...
    SECTS_AND_VIOLETS: {
        ...
        roles: [
            ...
            Roles.VILLAGEOIS.CRIEUR_PUBLIC_PUBLIC,
    ...
    Sects & Violets`,
        ...
        Pour ajouter encore plus de confusion, les Marginaux vont probablement mentir sur leur identité pendant toute la partie et peut être même que certains Villageois feront la même chose. Un Marginal qui meurt peut causer de terribles désavantages au village alors les Démons avisés voudront souvent les tuer dès que possible.
