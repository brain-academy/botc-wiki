...
`
    ...
    Sects & Violets`,
        ...
        detail:`
            ...
            Horloger, Faussaire, Fleuriste, Mathematicien, Sage, Bête de foire, Manipulateur, Vortox. Préparez-vous à une partie déchainée ! Le Vortox va créer une fausse information pour des rôles cruciaux tandis que la Bête de Foire et le Manipulateur vont semer le chaos et la méfiance. Vous aurez besoin d’être familier avec la folie et de la subtile différence entre les deux rôles mais si les joueurs sont aussi familiers avec la folie, ça peut être très amusant. Ce composition amène à des bluffs inhabituels, des accusations confuses et une expérience exubérante. 
`
    },
    DEADLY_PENANCE_DAY: {
